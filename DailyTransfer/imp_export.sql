...
/****** Object:  StoredProcedure [dbo].[imp_Export]    Script Date: 2016/9/2 上午 11:16:44 ******/
SET ANSI_NULLS ON
GO
...
--------------------------Export---------------------------
	...
	on t.id=s.id
		...
		t.PackingArrival = s.PackingArrival ,
		t.WhseArrival = s.WhseArrival ,
		t.PortArrival = s.PortArrival ,
		t.DocArrival = s.DocArrival ,
		t.Broker = s.Broker ,
		t.Insurer = s.Insurer ,
