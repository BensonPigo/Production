...
---------------------Order--------------------------------------
		...
		insert (
			...
			, ForecastCategory		, OnSiteSample			, PulloutCmplDate		, NeedProduction		, IsBuyBack
			...
			, s.ForecastCategory	, s.OnSiteSample		, s.PulloutCmplDate		, s.NeedProduction		, isnull (s.IsBuyBack, 0)
		)
