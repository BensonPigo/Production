...
CREATE FUNCTION [dbo].[getVNUnitTransfer](@type varchar(20), @oriunit varchar(8), @customsunit varchar(8), @oriqty numeric(13,4), @width numeric(5,1), @pcswidth numeric(7,4), @pcslength numeric(7,4), @pcskg numeric(7,4),@inputRatevalue numeric(28,18),@rate varchar(22), @Refno varchar(21) = '')
