...
CREATE FUNCTION [dbo].[getVNUnitTransfer](@type varchar(20), @oriunit varchar(8), @customsunit varchar(8), @oriqty numeric(11,2), @width numeric(5,2), @pcswidth numeric(5,2), @pcslength numeric(7,4), @pcskg numeric(7,4),@ratevalue numeric(28,18),@rate varchar(22))
