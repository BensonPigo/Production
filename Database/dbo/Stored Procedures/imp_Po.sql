...
from Trade_To_Pms.dbo.PO_Supp as b WITH (NOLOCK) inner join  #Trade_To_Pms_PO c ON b.ID = c.ID
...
SET  
	  ...
	  ,a.CfmETA =b.CfmETA,
	   a.BrandId = (select distinct a.BrandID from Orders a WITH (NOLOCK) where a.POID=b.ID)
...
select 
	  ...
	  ,b.RevisedETD
	  ,b.CfmETA 
	  ,(select distinct a.BrandID from Orders a WITH (NOLOCK) where a.POID=b.ID)
