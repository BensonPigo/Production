CREATE TABLE [dbo].[ADIDASComplain_Detail] (
    ...
    [StyleID]        VARCHAR (20)   NULL DEFAULT (''),
    [Supplier]       VARCHAR (6)    NULL DEFAULT (''),
    [Refno]          VARCHAR (20)   NULL DEFAULT (''),
    [CustPONo]       VARCHAR (30)   NULL DEFAULT (''),
    [SeasonId]       VARCHAR (10)   NULL DEFAULT (''),
    [BulkMR]         VARCHAR (10)   NULL DEFAULT (''),
    [SampleMR]       VARCHAR (10)   NULL DEFAULT (''),
