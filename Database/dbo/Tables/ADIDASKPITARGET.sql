CREATE TABLE [dbo].[ADIDASKPITARGET] (
    ...
    [XlsColumn]   DECIMAL (3)    CONSTRAINT [DF_ADIDASKPITARGET_XlsColumn] DEFAULT ((0)) NOT NULL,
    [Description] VARCHAR (50)   CONSTRAINT [DF_ADIDASKPITARGET_Description] DEFAULT ('') NOT NULL,
    [Target]      DECIMAL (5, 2) CONSTRAINT [DF_ADIDASKPITARGET_Target] DEFAULT ((0)) NOT NULL,
    [AddName]     VARCHAR (10)   CONSTRAINT [DF_ADIDASKPITARGET_AddName] DEFAULT ('') NOT NULL,
    [AddDate]     DATETIME       NULL,
    [EditName]    VARCHAR (10)   CONSTRAINT [DF_ADIDASKPITARGET_EditName] DEFAULT ('') NOT NULL,
