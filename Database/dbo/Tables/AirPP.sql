CREATE TABLE [dbo].[AirPP] (
    ...
    [Remark]            NVARCHAR (50)   CONSTRAINT [DF_AirPP_Remark] DEFAULT ('') NULL,
    ...
    [SubconDBCRemark]   NVARCHAR (100)  CONSTRAINT [DF_AirPP_SubconDBCRemark] DEFAULT ('') NULL,
    ...
    [SCIICRRemark]      NVARCHAR (50)   CONSTRAINT [DF_AirPP_SCIICRRemark] DEFAULT ('') NULL,
    ...
    [SuppDBCRemark]     NVARCHAR (50)   CONSTRAINT [DF_AirPP_SuppDBCRemark] DEFAULT ('') NULL,
    ...
    [BuyerDBCRemark]    NVARCHAR (50)   CONSTRAINT [DF_AirPP_BuyerDBCRemark] DEFAULT ('') NULL,
    [BuyerICRNo]        VARCHAR (13)    CONSTRAINT [DF_AirPP_BuyerICRNo] DEFAULT ('') NULL,
    [BuyerICRRemark]    NVARCHAR (50)   CONSTRAINT [DF_AirPP_BuyerICRRemark] DEFAULT ('') NULL,
    [BuyerRemark]       NVARCHAR (50)   CONSTRAINT [DF_AirPP_BuyerRemark] DEFAULT ('') NULL,
