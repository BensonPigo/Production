...
(
    ...
    [TotalGSDTime] NUMERIC(7, 2) CONSTRAINT [DF_AutomatedLineMapping_TotalGSDTime] DEFAULT (0) NOT NULL,  
    [HighestGSDTime] NUMERIC(6, 2) CONSTRAINT [DF_AutomatedLineMapping_HighestGSDTime] DEFAULT (0) NOT NULL,  
