...
(
    ...
    [Annotation] NVARCHAR(200) CONSTRAINT [DF_AutomatedLineMapping_Detail_Annotation] DEFAULT ('') NOT NULL, 
    ...
    [GSD] NUMERIC(6, 2) CONSTRAINT [DF_AutomatedLineMapping_Detail_GSD] DEFAULT (0) NOT NULL, 
