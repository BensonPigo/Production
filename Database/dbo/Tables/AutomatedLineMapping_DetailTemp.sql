CREATE TABLE [dbo].[AutomatedLineMapping_DetailTemp]
(
    [Ukey] bigint not null identity,
	[ID] INT NOT NULL , 
    [No] VARCHAR(2) NOT NULL , 
    [SewerManpower] tinyint NOT NULL , 
    [Seq] SMALLINT CONSTRAINT [DF_AutomatedLineMapping_DetailTemp_Seq] DEFAULT (0) NOT NULL, 
    [Quota] SMALLINT CONSTRAINT [DF_AutomatedLineMapping_DetailTemp_Quota] DEFAULT (0) NOT NULL, 
    [Location] VARCHAR(20) CONSTRAINT [DF_AutomatedLineMapping_DetailTemp_Location] DEFAULT ('') NOT NULL, 
    [PPA] VARCHAR CONSTRAINT [DF_AutomatedLineMapping_DetailTemp_PPA] DEFAULT ('') NOT NULL, 
    ...
    [TimeStudyDetailUkey] BIGINT CONSTRAINT [DF_AutomatedLineMapping_DetailTemp_TimeStudyDetailUkey] DEFAULT (0) NOT NULL, 
