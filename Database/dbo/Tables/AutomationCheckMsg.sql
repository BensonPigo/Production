...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'確認轉出資料的過程是否有異常包含廠商回傳 Error', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'AutomationCheckMsg', @level2type = N'COLUMN', @level2name = N'AutomationTransRecordUkey';
