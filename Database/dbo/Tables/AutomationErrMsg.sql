...
(
    ...
    [APIThread] VARCHAR(50) NOT NULL CONSTRAINT [DF_AutomationErrMsg_APIThread] DEFAULT (''), 
	[SuppAPIThread] VARCHAR(100) NOT NULL CONSTRAINT [DF_AutomationErrMsg_SuppAPIThread] DEFAULT (''), 
