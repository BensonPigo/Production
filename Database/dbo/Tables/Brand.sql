CREATE TABLE [dbo].[Brand] (
    ...
    [Customize1]                VARCHAR (20)   CONSTRAINT [DF_Brand_Customize1] DEFAULT ('') NOT NULL,
    [Customize2]                VARCHAR (20)   CONSTRAINT [DF_Brand_Customize2] DEFAULT ('') NOT NULL,
    [Customize3]                VARCHAR (20)   CONSTRAINT [DF_Brand_Customize3] DEFAULT ('') NOT NULL,
