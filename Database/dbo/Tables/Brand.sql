CREATE TABLE [dbo].[Brand] (
    ...
    [PayTermARIDBulk]           VARCHAR (5)    CONSTRAINT [DF_Brand_PayTermARIDBulk] DEFAULT ('') NULL,
    [PayTermARIDSample]         VARCHAR (5)    CONSTRAINT [DF_Brand_PayTermARIDSample] DEFAULT ('') NULL,
