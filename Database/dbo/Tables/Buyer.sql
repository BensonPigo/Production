CREATE TABLE [dbo].[Buyer] (
    ...
    [CountryID]  VARCHAR (2)    CONSTRAINT [DF_Buyer_CountryID] DEFAULT ('') NULL,
    [NameCH]     NVARCHAR (30)  CONSTRAINT [DF_Buyer_NameCH] DEFAULT ('') NULL,
    [NameEN]     NVARCHAR (40)  CONSTRAINT [DF_Buyer_NameEN] DEFAULT ('') NULL,
    [Tel]        VARCHAR (20)   CONSTRAINT [DF_Buyer_Tel] DEFAULT ('') NULL,
    [Fax]        VARCHAR (20)   CONSTRAINT [DF_Buyer_Fax] DEFAULT ('') NULL,
    [Contact1]   VARCHAR (20)   CONSTRAINT [DF_Buyer_Contact1] DEFAULT ('') NULL,
    [Contact2]   VARCHAR (20)   CONSTRAINT [DF_Buyer_Contact2] DEFAULT ('') NULL,
    [AddressCH]  NVARCHAR (50)  CONSTRAINT [DF_Buyer_AddressCH] DEFAULT ('') NULL,
    [AddressEN]  NVARCHAR (MAX) CONSTRAINT [DF_Buyer_AddressEN] DEFAULT ('') NULL,
    [BillTo1]    NVARCHAR (40)  CONSTRAINT [DF_Buyer_BillTo1] DEFAULT ('') NULL,
    [BillTo2]    NVARCHAR (40)  CONSTRAINT [DF_Buyer_BillTo2] DEFAULT ('') NULL,
    [BillTo3]    NVARCHAR (40)  CONSTRAINT [DF_Buyer_BillTo3] DEFAULT ('') NULL,
    [BillTo4]    NVARCHAR (40)  CONSTRAINT [DF_Buyer_BillTo4] DEFAULT ('') NULL,
    [BillTo5]    NVARCHAR (40)  CONSTRAINT [DF_Buyer_BillTo5] DEFAULT ('') NULL,
    [CurrencyID] VARCHAR (3)    CONSTRAINT [DF_Buyer_CurrencyID] DEFAULT ('') NULL,
    [Remark]     NVARCHAR (MAX) CONSTRAINT [DF_Buyer_Remark] DEFAULT ('') NULL,
    [ZipCode]    VARCHAR (6)    CONSTRAINT [DF_Buyer_ZipCode] DEFAULT ('') NULL,
    [Email]      NVARCHAR (50)  CONSTRAINT [DF_Buyer_Email] DEFAULT ('') NULL,
    [MrTeam]     VARCHAR (5)    CONSTRAINT [DF_Buyer_MrTeam] DEFAULT ('') NULL,
    [AddName]    VARCHAR (10)   CONSTRAINT [DF_Buyer_AddName] DEFAULT ('') NULL,
    [AddDate]    DATETIME       NULL,
    [EditName]   VARCHAR (10)   CONSTRAINT [DF_Buyer_EditName] DEFAULT ('') NULL,
    [EditDate]   DATETIME       NULL,
    [Junk]       BIT            CONSTRAINT [DF_Buyer_Junk] DEFAULT ((0)) NULL,
