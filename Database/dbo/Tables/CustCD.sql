CREATE TABLE [dbo].[CustCD] (
    ...
    [PayTermARIDBulk]   VARCHAR (5)    CONSTRAINT [DF_CustCD_PayTermARIDBulk] DEFAULT ('') NULL,
    [PayTermARIDSample] VARCHAR (5)    CONSTRAINT [DF_CustCD_PayTermARIDSample] DEFAULT ('') NULL,
