CREATE TABLE [dbo].[Debit] (
    ...
    [Title]          VARCHAR (30)    CONSTRAINT [DF_Debit_Title] DEFAULT ('') NULL,
    [SendFrom]       VARCHAR (40)    CONSTRAINT [DF_Debit_SendFrom] DEFAULT ('') NULL,
    [Attn]           VARCHAR (40)    CONSTRAINT [DF_Debit_Attn] DEFAULT ('') NULL,
    [CC]             VARCHAR (40)    CONSTRAINT [DF_Debit_CC] DEFAULT ('') NULL,
