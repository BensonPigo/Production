CREATE TABLE [dbo].[Debit] (
    ...
    [Title]          NVARCHAR (60)   CONSTRAINT [DF_Debit_Title] DEFAULT ('') NULL,
    [SendFrom]       NVARCHAR (80)   CONSTRAINT [DF_Debit_SendFrom] DEFAULT ('') NULL,
    [Attn]           NVARCHAR (80)   CONSTRAINT [DF_Debit_Attn] DEFAULT ('') NULL,
    [CC]             NVARCHAR (80)   CONSTRAINT [DF_Debit_CC] DEFAULT ('') NULL,
    ...
    [LCLName]        NVARCHAR (100)   CONSTRAINT [DF_Debit_LCLName] DEFAULT ('') NULL,
