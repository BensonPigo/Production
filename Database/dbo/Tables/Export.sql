CREATE TABLE [dbo].[Export] (
    ...
    [CYCFS]          VARCHAR (3)     CONSTRAINT [DF_Export_CYCFS] DEFAULT ('') NULL,
    ...
    [WeightKg]       NUMERIC (9, 2)  CONSTRAINT [DF_Export_WeightKg] DEFAULT ((0)) NULL,
    [NetKg]          NUMERIC (9, 2)  CONSTRAINT [DF_Export_NetKg] DEFAULT ((0)) NULL,
