CREATE TABLE [dbo].[Export_Detail] (
    ...
    [PoID]                    VARCHAR (13)    CONSTRAINT [DF_Export_Detail_PoID] DEFAULT ('') NOT NULL,
    ...
    [ExportIDOld]             VARCHAR (13)    CONSTRAINT [DF_Export_Detail_ExportIDOld] DEFAULT ('') NOT NULL,
    [Ukey]                    BIGINT          CONSTRAINT [DF_Export_Detail_Ukey] DEFAULT ((0)) NOT NULL,
    [Qty]                     DECIMAL (12, 2) CONSTRAINT [DF_Export_Detail_Qty] DEFAULT ((0)) NOT NULL,
    [Foc]                     DECIMAL (12, 2) CONSTRAINT [DF_Export_Detail_Foc] DEFAULT ((0)) NOT NULL,
    [Carton]                  NVARCHAR (1000) CONSTRAINT [DF_Export_Detail_Carton] DEFAULT ('') NOT NULL,
    [Confirm]                 BIT             CONSTRAINT [DF_Export_Detail_Confirm] DEFAULT ((0)) NOT NULL,
    [UnitId]                  VARCHAR (8)     CONSTRAINT [DF_Export_Detail_UnitId] DEFAULT ('') NOT NULL,
    [Price]                   DECIMAL (16, 4) CONSTRAINT [DF_Export_Detail_Price] DEFAULT ((0)) NOT NULL,
    [NetKg]                   DECIMAL (10, 2) CONSTRAINT [DF_Export_Detail_NetKg] DEFAULT ((0)) NOT NULL,
    [WeightKg]                DECIMAL (10, 2) CONSTRAINT [DF_Export_Detail_WeightKg] DEFAULT ((0)) NOT NULL,
    [Remark]                  NVARCHAR (600)  CONSTRAINT [DF_Export_Detail_Remark] DEFAULT ('') NOT NULL,
    [PayDesc]                 NVARCHAR (600)  CONSTRAINT [DF_Export_Detail_PayDesc] DEFAULT ('') NOT NULL,
    [LastEta]                 DATE            NULL,
    [Refno]                   VARCHAR (36)    CONSTRAINT [DF_Export_Detail_Refno] DEFAULT ('') NOT NULL,
    [SuppID]                  VARCHAR (6)     CONSTRAINT [DF_Export_Detail_SuppID] DEFAULT ('') NOT NULL,
    [Pino]                    VARCHAR (25)    CONSTRAINT [DF_Export_Detail_Pino] DEFAULT ('') NOT NULL,
    [Description]             NVARCHAR (MAX)  CONSTRAINT [DF_Export_Detail_Description] DEFAULT ('') NOT NULL,
    [UnitOld]                 VARCHAR (8)     CONSTRAINT [DF_Export_Detail_UnitOld] DEFAULT ('') NOT NULL,
    [PinoOld]                 VARCHAR (25)    CONSTRAINT [DF_Export_Detail_PinoOld] DEFAULT ('') NOT NULL,
    [SuppIDOld]               VARCHAR (6)     CONSTRAINT [DF_Export_Detail_SuppIDOld] DEFAULT ('') NOT NULL,
    [PriceOld]                DECIMAL (16, 4) CONSTRAINT [DF_Export_Detail_PriceOld] DEFAULT ((0)) NOT NULL,
    [PoType]                  VARCHAR (1)     CONSTRAINT [DF_Export_Detail_PoType] DEFAULT ('') NOT NULL,
    [FabricType]              VARCHAR (1)     CONSTRAINT [DF_Export_Detail_FabricType] DEFAULT ('') NOT NULL,
    [ShipPlanID]              VARCHAR (13)    CONSTRAINT [DF_Export_Detail_ShipPlanID] DEFAULT ('') NOT NULL,
    [ShipPlanHandle]          VARCHAR (10)    CONSTRAINT [DF_Export_Detail_ShipPlanHandle] DEFAULT ('') NOT NULL,
    [PoHandle]                VARCHAR (10)    CONSTRAINT [DF_Export_Detail_PoHandle] DEFAULT ('') NOT NULL,
    [PcHandle]                VARCHAR (10)    CONSTRAINT [DF_Export_Detail_PcHandle] DEFAULT ('') NOT NULL,
    [IsFormA]                 BIT             CONSTRAINT [DF_Export_Detail_IsFormA] DEFAULT ((0)) NOT NULL,
    [FormXDraftCFM]           DATE            NULL,
    [FormXINV]                NVARCHAR (600)  CONSTRAINT [DF_Export_Detail_FormXINV] DEFAULT ('') NOT NULL,
    [FormXReceived]           DATE            NULL,
    [FormXFTYEdit]            DATETIME        NULL,
    [FormXEdit]               DATETIME        NULL,
    [FormXPayINV]             NVARCHAR (600)  CONSTRAINT [DF_Export_Detail_FormXPayINV] DEFAULT ('') NOT NULL,
    [FormXType]               VARCHAR (8)     CONSTRAINT [DF_Export_Detail_FormXType] DEFAULT ('') NOT NULL,
    [FormXAwb]                VARCHAR (20)    CONSTRAINT [DF_Export_Detail_FormXAwb] DEFAULT ('') NOT NULL,
    [FormXCarrier]            VARCHAR (30)    CONSTRAINT [DF_Export_Detail_FormXCarrier] DEFAULT ('') NOT NULL,
    [FormXRemark]             NVARCHAR (600)  CONSTRAINT [DF_Export_Detail_FormXRemark] DEFAULT ('') NOT NULL,
    [AddName]                 VARCHAR (10)    CONSTRAINT [DF_Export_Detail_AddName] DEFAULT ('') NOT NULL,
    [AddDate]                 DATETIME        NULL,
    [EditDate]                DATETIME        NULL,
    [EditName]                VARCHAR (10)    CONSTRAINT [DF_Export_Detail_EditName] DEFAULT ('') NOT NULL,
    [BalanceQty]              DECIMAL (12, 2) CONSTRAINT [DF_Export_Detail_BalanceQty] DEFAULT ((0)) NOT NULL,
    [BalanceFOC]              DECIMAL (12, 2) CONSTRAINT [DF_Export_Detail_BalanceFOC] DEFAULT ((0)) NOT NULL,
    [CurrencyId]              VARCHAR (3)     CONSTRAINT [DF_Export_Detail_CurrencyId] DEFAULT ('') NOT NULL,
    [InvoiceNo]               VARCHAR (MAX)   CONSTRAINT [DF_Export_Detail_InvoiceNo] DEFAULT ('') NOT NULL,
    ...
    [EarlyShipReason]         VARCHAR (5)     CONSTRAINT [DF_Export_Detail_EarlyShipReason] DEFAULT ('') NOT NULL,
    [Export_ShareAmount_Ukey] BIGINT          CONSTRAINT [DF_Export_Detail_Export_ShareAmount_Ukey] DEFAULT ((0)) NOT NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'EarlyShipReason', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Export_Detail', @level2type = N'COLUMN', @level2name = N'EarlyShipReason';
