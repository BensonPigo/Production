CREATE TABLE [dbo].[Export_Detail] (
    ...
    [Carton]         NVARCHAR (MAX)  CONSTRAINT [DF_Export_Detail_Carton] DEFAULT ('') NULL,
    ...
    [Remark]         NVARCHAR (60)   CONSTRAINT [DF_Export_Detail_Remark] DEFAULT ('') NULL,
    [PayDesc]        NVARCHAR (150)  CONSTRAINT [DF_Export_Detail_PayDesc] DEFAULT ('') NULL,
    [LastEta]        DATE            NULL,
    ...
    [PriceOld]       NUMERIC (11, 4) CONSTRAINT [DF_Export_Detail_PriceOld] DEFAULT ((0)) NOT NULL,
    ...
    [FormXINV]       NVARCHAR (MAX)  CONSTRAINT [DF_Export_Detail_FormXINV] DEFAULT ('') NULL,
    [FormXReceived]  DATE            NULL,
    [FormXFTYEdit]   DATETIME        NULL,
    [FormXEdit]      DATETIME        NULL,
    [FormXPayINV]    NVARCHAR (MAX)  CONSTRAINT [DF_Export_Detail_FormXPayINV] DEFAULT ('') NULL,
    ...
    [FormXRemark]    NVARCHAR (60)   CONSTRAINT [DF_Export_Detail_FormXRemark] DEFAULT ('') NULL,
