CREATE TABLE [dbo].[Fabric] (
    ...
    [BrandID]                 VARCHAR (8)     CONSTRAINT [DF_Fabric_BrandID] DEFAULT ('') NOT NULL,
    [Refno]                   VARCHAR (36)    CONSTRAINT [DF_Fabric_Refno] DEFAULT ('') NOT NULL,
    [Junk]                    BIT             CONSTRAINT [DF_Fabric_Junk] DEFAULT ((0)) NOT NULL,
    [Type]                    VARCHAR (1)     CONSTRAINT [DF_Fabric_Type] DEFAULT ('') NOT NULL,
    [MtlTypeID]               VARCHAR (20)    CONSTRAINT [DF_Fabric_MtlTypeID] DEFAULT ('') NOT NULL,
    [BomTypeCalculate]        BIT             CONSTRAINT [DF_Fabric_BomTypeCalculate] DEFAULT ((0)) NOT NULL,
    [Description]             NVARCHAR (150)  CONSTRAINT [DF_Fabric_Description] DEFAULT ('') NOT NULL,
    [DescDetail]              NVARCHAR (MAX)  CONSTRAINT [DF_Fabric_DescDetail] DEFAULT ('') NOT NULL,
    [LossType]                TINYINT         CONSTRAINT [DF_Fabric_LossType] DEFAULT ((0)) NOT NULL,
    [LossPercent]             DECIMAL (4, 1)  CONSTRAINT [DF_Fabric_LossPercent] DEFAULT ((0)) NOT NULL,
    [LossQty]                 SMALLINT        CONSTRAINT [DF_Fabric_LossQty] DEFAULT ((0)) NOT NULL,
    [LossStep]                INT             CONSTRAINT [DF_Fabric_LossStep] DEFAULT ((0)) NOT NULL,
    [UsageUnit]               VARCHAR (8)     CONSTRAINT [DF_Fabric_UsageUnit] DEFAULT ('') NOT NULL,
    [Width]                   DECIMAL (5, 2)  CONSTRAINT [DF_Fabric_Width] DEFAULT ((0)) NOT NULL,
    [Weight]                  DECIMAL (10, 4) CONSTRAINT [DF_Fabric_Weight] DEFAULT ((0)) NOT NULL,
    [CBM]                     DECIMAL (7, 2)  CONSTRAINT [DF_Fabric_CBM] DEFAULT ((0)) NOT NULL,
    [CBMWeight]               DECIMAL (10, 4) CONSTRAINT [DF_Fabric_CBMWeight] DEFAULT ((0)) NOT NULL,
    [NoSizeUnit]              BIT             CONSTRAINT [DF_Fabric_NoSizeUnit] DEFAULT ((0)) NOT NULL,
    [BomTypeSize]             BIT             CONSTRAINT [DF_Fabric_BomTypeSize] DEFAULT ((0)) NOT NULL,
    [BomTypeColor]            BIT             CONSTRAINT [DF_Fabric_BomTypeColor] DEFAULT ((0)) NOT NULL,
    [ConstructionID]          VARCHAR (20)    CONSTRAINT [DF_Fabric_ConstructionID] DEFAULT ('') NOT NULL,
    [MatchFabric]             VARCHAR (1)     CONSTRAINT [DF_Fabric_MatchFabric] DEFAULT ('') NOT NULL,
    [WeaveTypeID]             VARCHAR (20)    CONSTRAINT [DF_Fabric_WeaveTypeID] DEFAULT ('') NOT NULL,
    [AddName]                 VARCHAR (10)    CONSTRAINT [DF_Fabric_AddName] DEFAULT ('') NOT NULL,
    [AddDate]                 DATETIME        NULL,
    [EditName]                VARCHAR (10)    CONSTRAINT [DF_Fabric_EditName] DEFAULT ('') NOT NULL,
    [EditDate]                DATETIME        NULL,
    [NLCode]                  VARCHAR (9)     CONSTRAINT [DF_Fabric_NLCode] DEFAULT ('') NOT NULL,
    [HSCode]                  VARCHAR (11)    CONSTRAINT [DF_Fabric_HSCode] DEFAULT ('') NOT NULL,
    [CustomsUnit]             VARCHAR (8)     CONSTRAINT [DF_Fabric_CustomsUnit] DEFAULT ('') NOT NULL,
    [PcsWidth]                DECIMAL (7, 4)  CONSTRAINT [DF_Fabric_PcsWidth] DEFAULT ((0)) NOT NULL,
    [PcsLength]               DECIMAL (7, 4)  CONSTRAINT [DF_Fabric_PcsLength] DEFAULT ((0)) NOT NULL,
    [PcsKg]                   DECIMAL (5, 4)  CONSTRAINT [DF_Fabric_PcsKg] DEFAULT ((0)) NOT NULL,
    [NoDeclare]               BIT             CONSTRAINT [DF_Fabric_NoDeclare] DEFAULT ((0)) NOT NULL,
    [NLCodeEditName]          VARCHAR (10)    CONSTRAINT [DF_Fabric_NLCodeEditName] DEFAULT ('') NOT NULL,
    [NLCodeEditDate]          DATETIME        NULL,
    [WeightM2]                DECIMAL (5, 1)  CONSTRAINT [DF_Fabric_WeightM2] DEFAULT ((0)) NOT NULL,
    ...
    [BomTypeCalculateWeight]  BIT             CONSTRAINT [DF_Fabric_BomTypeCalculateWeight] DEFAULT ((0)) NOT NULL,
    [IsRecycled]              BIT             CONSTRAINT [DF_Fabric_IsRecycled] DEFAULT ((0)) NOT NULL,
    [Finish]                  VARCHAR (50)    DEFAULT ('') NOT NULL,
    [BrandRefNo]              VARCHAR (50)    DEFAULT ('') NOT NULL,
    [Keyword]                 VARCHAR (MAX)   CONSTRAINT [DF_Fabric_Keyword] DEFAULT ('') NOT NULL,
    [Textile]                 BIT             CONSTRAINT [DF_Fabric_Textile] DEFAULT ((0)) NOT NULL,
    [BomTypeArticle]          BIT             CONSTRAINT [DF_Fabric_BomTypeArticle] DEFAULT ((0)) NOT NULL,
    [BomTypeCOO]              BIT             CONSTRAINT [DF_Fabric_BomTypeCOO] DEFAULT ((0)) NOT NULL,
    [BomTypeGender]           BIT             CONSTRAINT [DF_Fabric_BomTypeGender] DEFAULT ((0)) NOT NULL,
    [BomTypeCustomerSize]     BIT             CONSTRAINT [DF_Fabric_BomTypeCustomerSize] DEFAULT ((0)) NOT NULL,
    [BomTypeDecLabelSize]     BIT             CONSTRAINT [DF_Fabric_BomTypeDecLabelSize] DEFAULT ((0)) NOT NULL,
    [BomTypeBrandFactoryCode] BIT             CONSTRAINT [DF_Fabric_BomTypeBrandFactoryCode] DEFAULT ((0)) NOT NULL,
    [BomTypeStyle]            BIT             CONSTRAINT [DF_Fabric_BomTypeStyle] DEFAULT ((0)) NOT NULL,
    [BomTypeStyleLocation]    BIT             CONSTRAINT [DF_Fabric_BomTypeStyleLocation] DEFAULT ((0)) NOT NULL,
