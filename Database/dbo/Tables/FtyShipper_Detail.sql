...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'出口工廠', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FtyShipper_Detail', @level2type = N'COLUMN', @level2name = 'ShipperID';
