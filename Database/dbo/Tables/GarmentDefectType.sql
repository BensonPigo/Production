CREATE TABLE [dbo].[GarmentDefectType] (
    ...
    [AddName]          VARCHAR (10)   CONSTRAINT [DF_GarmentDefectType_AddName] DEFAULT ('') NOT NULL,
    [AddDate]          DATETIME       NOT NULL,
    [EditName]         VARCHAR (10)   CONSTRAINT [DF_GarmentDefectType_EditName] DEFAULT ('') NOT NULL,
    [EditDate]         DATETIME       NULL,
    [LocalDescription] NVARCHAR (100) CONSTRAINT [df_empty] DEFAULT ('') NOT NULL,
