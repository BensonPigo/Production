CREATE TABLE [dbo].[Invtrans] (
    ...
    [ConfirmHandle]       VARCHAR (10)    CONSTRAINT [DF_Invtrans_ConfirmHandle] DEFAULT ('') NOT NULL,
    ...
    [TransferFactory]     VARCHAR (8)     CONSTRAINT [DF_Invtrans_TransferFactory] DEFAULT ('') NOT NULL,
    ...
    [PoID]                VARCHAR (13)    CONSTRAINT [DF_Invtrans_PoID] DEFAULT ('') NOT NULL,
    [Seq1]                VARCHAR (3)     CONSTRAINT [DF_Invtrans_Seq1] DEFAULT ('') NOT NULL,
    [Seq2]                VARCHAR (2)     CONSTRAINT [DF_Invtrans_Seq2] DEFAULT ('') NOT NULL,
    [InventoryPOID]       VARCHAR (13)    CONSTRAINT [DF_Invtrans_InventoryPOID] DEFAULT ('') NOT NULL,
    [InventorySeq1]       VARCHAR (3)     CONSTRAINT [DF_Invtrans_InventorySeq1] DEFAULT ('') NOT NULL,
    [InventorySeq2]       VARCHAR (2)     CONSTRAINT [DF_Invtrans_InventorySeq2] DEFAULT ('') NOT NULL,
    [Remark]              NVARCHAR (MAX)  CONSTRAINT [DF_Invtrans_Remark] DEFAULT ('') NOT NULL,
    [CurrencyID]          VARCHAR (3)     CONSTRAINT [DF_Invtrans_CurrencyID] DEFAULT ('') NOT NULL,
    [JunkPo3]             VARCHAR (1)     CONSTRAINT [DF_Invtrans_JunkPo3] DEFAULT ('') NOT NULL,
    [Deadline]            DATE            NULL,
    [ReasonID]            VARCHAR (5)     CONSTRAINT [DF_Invtrans_ReasonID] DEFAULT ('') NOT NULL,
    [Payable]             VARCHAR (1)     CONSTRAINT [DF_Invtrans_Payable] DEFAULT ('') NOT NULL,
    [PoHandle]            VARCHAR (10)    CONSTRAINT [DF_Invtrans_PoHandle] DEFAULT ('') NOT NULL,
    [PoSmr]               VARCHAR (10)    CONSTRAINT [DF_Invtrans_PoSmr] DEFAULT ('') NOT NULL,
    [OrderHandle]         VARCHAR (10)    CONSTRAINT [DF_Invtrans_OrderHandle] DEFAULT ('') NOT NULL,
    [OrderSmr]            VARCHAR (10)    CONSTRAINT [DF_Invtrans_OrderSmr] DEFAULT ('') NOT NULL,
    [PoFactory]           VARCHAR (8)     CONSTRAINT [DF_Invtrans_PoFactory] DEFAULT ('') NOT NULL,
    [LimitHandle]         VARCHAR (10)    CONSTRAINT [DF_Invtrans_LimitHandle] DEFAULT ('') NOT NULL,
    [LimitSmr]            VARCHAR (10)    CONSTRAINT [DF_Invtrans_LimitSmr] DEFAULT ('') NOT NULL,
    [AuthMr]              VARCHAR (10)    CONSTRAINT [DF_Invtrans_AuthMr] DEFAULT ('') NOT NULL,
    [VoucherID]           VARCHAR (16)    CONSTRAINT [DF_Invtrans_VoucherID] DEFAULT ('') NOT NULL,
    [TransferUkey]        BIGINT          CONSTRAINT [DF_Invtrans_TransferUkey] DEFAULT ((0)) NOT NULL,
    [Po3QtyOld]           DECIMAL (10, 2) CONSTRAINT [DF_Invtrans_Po3QtyOld] DEFAULT ((0)) NOT NULL,
    [InventoryQtyOld]     DECIMAL (10, 2) CONSTRAINT [DF_Invtrans_InventoryQtyOld] DEFAULT ((0)) NOT NULL,
    [ProjectOld]          VARCHAR (5)     CONSTRAINT [DF_Invtrans_ProjectOld] DEFAULT ('') NOT NULL,
    [BrandID]             VARCHAR (8)     CONSTRAINT [DF_Invtrans_BrandID] DEFAULT ('') NOT NULL,
    [BrandGroup]          VARCHAR (8)     CONSTRAINT [DF_Invtrans_BrandGroup] DEFAULT ('') NOT NULL,
    [Refno]               VARCHAR (36)    CONSTRAINT [DF_Invtrans_Refno] DEFAULT ('') NULL,
    ...
    [MtlTypeID]           VARCHAR (20)    CONSTRAINT [DF_Invtrans_MtlTypeID] DEFAULT ('') NOT NULL,
    [ProjectID]           VARCHAR (5)     CONSTRAINT [DF_Invtrans_ProjectID] DEFAULT ('') NOT NULL,
    [SeasonID]            VARCHAR (10)    CONSTRAINT [DF_Invtrans_SeasonID] DEFAULT ('') NOT NULL,
    [StyleID]             VARCHAR (15)    CONSTRAINT [DF_Invtrans_StyleID] DEFAULT ('') NOT NULL,
    [UnitID]              VARCHAR (8)     CONSTRAINT [DF_Invtrans_UnitID] DEFAULT ('') NOT NULL,
    [BomArticle]          VARCHAR (8)     CONSTRAINT [DF_Invtrans_BomArticle] DEFAULT ('') NOT NULL,
    [BomFactory]          VARCHAR (10)    CONSTRAINT [DF_Invtrans_BomFactory] DEFAULT ('') NOT NULL,
    [BomBuymonth]         VARCHAR (10)    CONSTRAINT [DF_Invtrans_BomBuymonth] DEFAULT ('') NOT NULL,
    ...
    [EditName]            VARCHAR (10)    CONSTRAINT [DF_Invtrans_EditName] DEFAULT ('') NOT NULL,
    [Ukey]                BIGINT          CONSTRAINT [DF_Invtrans_Ukey] DEFAULT ((0)) NOT NULL,
    [CreateDate]          DATE            NULL,
    [seq70poid]           VARCHAR (13)    CONSTRAINT [DF_Invtrans_seq70poid] DEFAULT ('') NOT NULL,
    [seq70seq1]           VARCHAR (3)     CONSTRAINT [DF_Invtrans_seq70seq1] DEFAULT ('') NOT NULL,
    [seq70seq2]           VARCHAR (2)     CONSTRAINT [DF_Invtrans_seq70seq2] DEFAULT ('') NOT NULL,
    [TransferMDivisionID] VARCHAR (8)     CONSTRAINT [DF_Invtrans_TransferMDivisionID] DEFAULT ('') NOT NULL,
