CREATE TABLE [dbo].[LocalItem_ThreadColorPrice] (
    ...
    [AddName]       VARCHAR (15)    CONSTRAINT [DF_LocalItem_ThreadColorPrice_AddName] DEFAULT ('') NULL,
    [AddDate]       DATETIME        NULL,
    [EditName]      VARCHAR (15)    CONSTRAINT [DF_LocalItem_ThreadColorPrice_EditName] DEFAULT ('') NULL,
