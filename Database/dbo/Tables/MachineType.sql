CREATE TABLE [dbo].[MachineType] (
    ...
    [Description]    NVARCHAR (60)  CONSTRAINT [DF_MachineType_Description] DEFAULT ('') NOT NULL,
    [DescCH]         NVARCHAR (60)  CONSTRAINT [DF_MachineType_DescCH] DEFAULT ('') NOT NULL,
    [ISO]            VARCHAR (10)   CONSTRAINT [DF_MachineType_ISO] DEFAULT ('') NOT NULL,
    [ArtworkTypeID]  VARCHAR (20)   CONSTRAINT [DF_MachineType_ArtworkTypeID] DEFAULT ('') NOT NULL,
    [Mold]           BIT            CONSTRAINT [DF_MachineType_Mold] DEFAULT ((0)) NOT NULL,
    [RPM]            INT            CONSTRAINT [DF_MachineType_RPM] DEFAULT ((0)) NOT NULL,
    [Stitches]       DECIMAL (6, 1) CONSTRAINT [DF_MachineType_Stitches] DEFAULT ((0)) NOT NULL,
    [Picture1]       NVARCHAR (60)  CONSTRAINT [DF_MachineType_Picture1] DEFAULT ('') NOT NULL,
    [Picture2]       NVARCHAR (60)  CONSTRAINT [DF_MachineType_Picture2] DEFAULT ('') NOT NULL,
    [MachineAllow]   DECIMAL (4, 2) CONSTRAINT [DF_MachineType_MachineAllow] DEFAULT ((0)) NOT NULL,
    [ManAllow]       DECIMAL (4, 2) CONSTRAINT [DF_MachineType_ManAllow] DEFAULT ((0)) NOT NULL,
    [MachineGroupID] VARCHAR (2)    CONSTRAINT [DF_MachineType_MachineGroupID] DEFAULT ('') NOT NULL,
    [Junk]           BIT            CONSTRAINT [DF_MachineType_Junk] DEFAULT ((0)) NOT NULL,
    [AddName]        VARCHAR (10)   CONSTRAINT [DF_MachineType_AddName] DEFAULT ('') NOT NULL,
    [AddDate]        DATETIME       NULL,
    [EditName]       VARCHAR (10)   CONSTRAINT [DF_MachineType_EditName] DEFAULT ('') NOT NULL,
    [EditDate]       DATETIME       NULL,
    [isThread]       BIT            CONSTRAINT [DF_MachineType_isThread] DEFAULT ((0)) NOT NULL,
    [MasterGroupID]  VARCHAR (2)    CONSTRAINT [DF_MachineType_MasterGroupID] DEFAULT ('') NOT NULL,
