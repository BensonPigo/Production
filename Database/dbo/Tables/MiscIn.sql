CREATE TABLE [dbo].[MiscIn] (
    ...
    [cDate]       DATE           NULL,
    [MDivisionid] VARCHAR (8)    CONSTRAINT [DF_MiscIn_Factoryid] DEFAULT ('') NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'工廠別', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'MiscIn', @level2type = N'COLUMN', @level2name = N'MDivisionid';
