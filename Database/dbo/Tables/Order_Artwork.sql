CREATE TABLE [dbo].[Order_Artwork] (
    ...
    [PatternCode]   VARCHAR (10)   CONSTRAINT [DF_Order_Artwork_PatternCode] DEFAULT ('') NULL,
    [PatternDesc]   NVARCHAR (40)  CONSTRAINT [DF_Order_Artwork_PatternDesc] DEFAULT ('') NULL,
