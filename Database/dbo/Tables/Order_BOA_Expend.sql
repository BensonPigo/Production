CREATE TABLE [dbo].[Order_BOA_Expend] (
    ...
    [Price]           NUMERIC (8, 4) CONSTRAINT [DF_Order_BOA_Expend_Price] DEFAULT ((0)) NULL,
    [UsageQty]        NUMERIC (8, 2) CONSTRAINT [DF_Order_BOA_Expend_UsageQty] DEFAULT ((0)) NULL,
    ...
    [SysUsageQty]     NUMERIC (8, 2) CONSTRAINT [DF_Order_BOA_Expend_SysUsageQty] DEFAULT ((0)) NOT NULL,
    [Remark]          NVARCHAR (MAX) CONSTRAINT [DF_Order_BOA_Expend_Remark] DEFAULT ('') NULL,
    [BomFactory]      VARCHAR (10)   CONSTRAINT [DF_Order_BOA_Expend_BomFactory] DEFAULT ('') NULL,
