CREATE TABLE [dbo].[Order_BOA_Expend] (
    ...
    [OrderQty]         DECIMAL (6)     CONSTRAINT [DF_Order_BOA_Expend_OrderQty] DEFAULT ((0)) NOT NULL,
    ...
    [Price]            DECIMAL (16, 4) CONSTRAINT [DF_Order_BOA_Expend_Price] DEFAULT ((0)) NOT NULL,
    [UsageQty]         DECIMAL (11, 2) CONSTRAINT [DF_Order_BOA_Expend_UsageQty] DEFAULT ((0)) NOT NULL,
    [UsageUnit]        VARCHAR (8)     CONSTRAINT [DF_Order_BOA_Expend_UsageUnit] DEFAULT ('') NOT NULL,
    [Article]          VARCHAR (8)     CONSTRAINT [DF_Order_BOA_Expend_Article] DEFAULT ('') NOT NULL,
    [SuppColor]        NVARCHAR (MAX)  CONSTRAINT [DF_Order_BOA_Expend_SuppColor] DEFAULT ('') NOT NULL,
    [SizeCode]         VARCHAR (8)     CONSTRAINT [DF_Order_BOA_Expend_SizeCode] DEFAULT ('') NOT NULL,
    [OrderIdList]      NVARCHAR (MAX)  CONSTRAINT [DF_Order_BOA_Expend_OrderIdList] DEFAULT ('') NOT NULL,
    [SysUsageQty]      NUMERIC (11, 2) CONSTRAINT [DF_Order_BOA_Expend_SysUsageQty] DEFAULT ((0)) NOT NULL,
    [Remark]           NVARCHAR (MAX)  CONSTRAINT [DF_Order_BOA_Expend_Remark] DEFAULT ('') NOT NULL,
    [BomFactory]       VARCHAR (8)     CONSTRAINT [DF_Order_BOA_Expend_BomFactory] DEFAULT ('') NOT NULL,
    [BomCountry]       VARCHAR (2)     CONSTRAINT [DF_Order_BOA_Expend_BomCountry] DEFAULT ('') NOT NULL,
    [BomStyle]         VARCHAR (15)    CONSTRAINT [DF_Order_BOA_Expend_BomStyle] DEFAULT ('') NOT NULL,
    [BomCustCD]        VARCHAR (20)    CONSTRAINT [DF_Order_BOA_Expend_BomCustCD] DEFAULT ('') NOT NULL,
    [BomArticle]       VARCHAR (8)     CONSTRAINT [DF_Order_BOA_Expend_BomArticle] DEFAULT ('') NOT NULL,
    [BomBuymonth]      VARCHAR (10)    CONSTRAINT [DF_Order_BOA_Expend_BomBuymonth] DEFAULT ('') NOT NULL,
    [AddName]          VARCHAR (10)    CONSTRAINT [DF_Order_BOA_Expend_AddName] DEFAULT ('') NOT NULL,
    [AddDate]          DATETIME        NULL,
    [EditName]         VARCHAR (10)    CONSTRAINT [DF_Order_BOA_Expend_EditName] DEFAULT ('') NOT NULL,
    [EditDate]         DATETIME        NULL,
    [Keyword]          VARCHAR (MAX)   CONSTRAINT [DF_Order_BOA_Expend_Keyword] DEFAULT ('') NOT NULL,
    [Special]          NVARCHAR (MAX)  CONSTRAINT [DF_Order_BOA_Expend_Special] DEFAULT ('') NOT NULL,
