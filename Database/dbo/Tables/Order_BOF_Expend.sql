CREATE TABLE [dbo].[Order_BOF_Expend] (
    ...
    [OrderQty]      NUMERIC (8, 4) CONSTRAINT [DF_Order_BOF_Expend_OrderQty] DEFAULT ((0)) NULL,
    [Price]         NUMERIC (8, 4) CONSTRAINT [DF_Order_BOF_Expend_Price] DEFAULT ((0)) NULL,
    [UsageQty]      NUMERIC (8, 2) CONSTRAINT [DF_Order_BOF_Expend_UsageQty] DEFAULT ((0)) NULL,
    [UsageUnit]     VARCHAR (8)    CONSTRAINT [DF_Order_BOF_Expend_UsageUnit] DEFAULT ('') NULL,
    [Width]         NUMERIC (3, 1) CONSTRAINT [DF_Order_BOF_Expend_Width] DEFAULT ((0)) NULL,
    [SysUsageQty]   NUMERIC (8, 2) CONSTRAINT [DF_Order_BOF_Expend_SysUsageQty] DEFAULT ((0)) NULL,
