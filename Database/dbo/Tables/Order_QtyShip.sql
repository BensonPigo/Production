CREATE TABLE [dbo].[Order_QtyShip] (
    ...
    [ShipmodeID]            VARCHAR (10)   CONSTRAINT [DF_Order_QtyShip_ShipmodeID] DEFAULT ('') NOT NULL,
    [BuyerDelivery]         DATE           NULL,
    [FtyKPI]                DATE           NULL,
    [ReasonID]              VARCHAR (5)    CONSTRAINT [DF_Order_QtyShip_ReasonID] DEFAULT ('') NOT NULL,
    [Qty]                   INT            CONSTRAINT [DF_Order_QtyShip_Qty] DEFAULT ((0)) NOT NULL,
    [OriQty]                INT            CONSTRAINT [DF_Order_QtyShip_OriQty] DEFAULT ((0)) NOT NULL,
    [EstPulloutDate]        DATE           NULL,
    [SDPDate]               DATE           NULL,
    [ProdRemark]            NVARCHAR (100) CONSTRAINT [DF_Order_QtyShip_ProdRemark] DEFAULT ('') NOT NULL,
    [ShipRemark]            NVARCHAR (30)  CONSTRAINT [DF_Order_QtyShip_ShipRemark] DEFAULT ('') NOT NULL,
    [OutstandingInCharge]   VARCHAR (10)   CONSTRAINT [DF_Order_QtyShip_OutstandingInCharge] DEFAULT ('') NOT NULL,
    [OutstandingDate]       DATETIME       NULL,
    [OutstandingReason]     VARCHAR (5)    CONSTRAINT [DF_Order_QtyShip_OutstandingReason] DEFAULT ('') NOT NULL,
    [OutstandingRemark]     NVARCHAR (60)  CONSTRAINT [DF_Order_QtyShip_OutstandingRemark] DEFAULT ('') NOT NULL,
    [AddName]               VARCHAR (10)   CONSTRAINT [DF_Order_QtyShip_AddName] DEFAULT ('') NOT NULL,
    [AddDate]               DATETIME       NULL,
    [EditName]              VARCHAR (10)   CONSTRAINT [DF_Order_QtyShip_EditName] DEFAULT ('') NOT NULL,
    [EditDate]              DATETIME       NULL,
    [ReadyDate]             DATE           NULL,
    [CFAIs3rdInspect]       BIT            DEFAULT ((0)) NOT NULL,
    [CFA3rdInspectResult]   VARCHAR (16)   CONSTRAINT [DF_Order_QtyShip_CFA3rdInspectResult] DEFAULT ('') NOT NULL,
    [CFA3rdInspectDate]     DATE           NULL,
    [CFAFinalInspectResult] VARCHAR (16)   CONSTRAINT [DF_Order_QtyShip_CFAFinalInspectResult] DEFAULT ('') NOT NULL,
    [CFAFinalInspectDate]   DATE           NULL,
    [CFAUpdateDate]         DATE           NULL,
    [CFARemark]             NVARCHAR (500) CONSTRAINT [DF_Order_QtyShip_CFARemark] DEFAULT ('') NOT NULL,
    [IDD]                   DATE           NULL,
    [IDDEditName]           VARCHAR (10)   CONSTRAINT [DF_Order_QtyShip_IDDEditName] DEFAULT ('') NOT NULL,
    [IDDEditDate]           DATETIME       NULL,
    [CFAIs3rdInspectHandle] VARCHAR (10)   CONSTRAINT [DF_Order_QtyShip_CFAIs3rdInspectHandle] DEFAULT ('') NOT NULL,
    [CFAFinalInspectHandle] VARCHAR (10)   CONSTRAINT [DF_Order_QtyShip_CFAFinalInspectHandle] DEFAULT ('') NOT NULL,
    [ClogReasonID]          VARCHAR (5)    CONSTRAINT [DF_Order_QtyShip_ClogReasonID] DEFAULT ('') NOT NULL,
