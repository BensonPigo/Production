CREATE TABLE [dbo].[Order_UnitPrice] (
    ...
    [POPrice]   NUMERIC (7, 2) CONSTRAINT [DF_Order_UnitPrice_POPrice] DEFAULT ((0)) NOT NULL,
    [QuotCost]  NUMERIC (7, 2) CONSTRAINT [DF_Order_UnitPrice_QuotCost] DEFAULT ((0)) NULL,
    [DestPrice] NUMERIC (7, 2) CONSTRAINT [DF_Order_UnitPrice_DestPrice] DEFAULT ((0)) NULL,
