CREATE TABLE [dbo].[Order_UnitPrice] (
    ...
    [POPrice]   DECIMAL (16, 4) CONSTRAINT [DF_Order_UnitPrice_POPrice] DEFAULT ((0)) NOT NULL,
    [QuotCost]  DECIMAL (7, 2)  CONSTRAINT [DF_Order_UnitPrice_QuotCost] DEFAULT ((0)) NOT NULL,
    [DestPrice] DECIMAL (16, 4) CONSTRAINT [DF_Order_UnitPrice_DestPrice] DEFAULT ((0)) NOT NULL,
    [AddName]   VARCHAR (10)    CONSTRAINT [DF_Order_UnitPrice_AddName] DEFAULT ('') NOT NULL,
    [AddDate]   DATETIME        NULL,
    [EditName]  VARCHAR (10)    CONSTRAINT [DF_Order_UnitPrice_EditName] DEFAULT ('') NOT NULL,
