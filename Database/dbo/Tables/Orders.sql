CREATE TABLE [dbo].[Orders] (
    ...
    [CMPPrice]               DECIMAL (16, 4) CONSTRAINT [DF_Orders_CMPPrice] DEFAULT ((0)) NOT NULL,
    [CMPQDate]               DATE            NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'SCHD LETA', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Orders', @level2type = N'COLUMN', @level2name = N'SCHDLETA';
