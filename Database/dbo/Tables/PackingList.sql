CREATE TABLE [dbo].[PackingList] (
    ...
    [OrderID]               VARCHAR (13)    CONSTRAINT [DF_PackingList_OrderID] DEFAULT ('') NOT NULL,
    [OrderShipmodeSeq]      VARCHAR (2)     CONSTRAINT [DF_PackingList_OrderShipmodeSeq] DEFAULT ('') NOT NULL,
    [ShipModeID]            VARCHAR (10)    CONSTRAINT [DF_PackingList_ShipModeID] DEFAULT ('') NOT NULL,
    [BrandID]               VARCHAR (8)     CONSTRAINT [DF_PackingList_BrandID] DEFAULT ('') NOT NULL,
    [Dest]                  VARCHAR (2)     CONSTRAINT [DF_PackingList_Dest] DEFAULT ('') NOT NULL,
    [CustCDID]              VARCHAR (16)    CONSTRAINT [DF_PackingList_CustCDID] DEFAULT ('') NOT NULL,
    [CTNQty]                INT             CONSTRAINT [DF_PackingList_CTNQty] DEFAULT ((0)) NOT NULL,
    [ShipQty]               INT             CONSTRAINT [DF_PackingList_ShipQty] DEFAULT ((0)) NOT NULL,
    [NW]                    DECIMAL (9, 3)  CONSTRAINT [DF_PackingList_NW] DEFAULT ((0)) NOT NULL,
    [GW]                    DECIMAL (9, 3)  CONSTRAINT [DF_PackingList_GW] DEFAULT ((0)) NOT NULL,
    [NNW]                   DECIMAL (9, 3)  CONSTRAINT [DF_PackingList_NNW] DEFAULT ((0)) NOT NULL,
    [CBM]                   DECIMAL (11, 4) CONSTRAINT [DF_PackingList_CBM] DEFAULT ((0)) NOT NULL,
    [CargoReadyDate]        DATE            NULL,
    [Remark]                NVARCHAR (150)  CONSTRAINT [DF_PackingList_Remark] DEFAULT ('') NOT NULL,
    [EstCTNBooking]         DATE            NULL,
    [EstCTNArrive]          DATE            NULL,
    [ApvToPurchase]         BIT             CONSTRAINT [DF_PackingList_ApvToPurchase] DEFAULT ((0)) NOT NULL,
    [ApvToPurchaseDate]     DATE            NULL,
    [LocalPOID]             VARCHAR (16)    CONSTRAINT [DF_PackingList_LocalPOID] DEFAULT ('') NOT NULL,
    [Status]                VARCHAR (15)    CONSTRAINT [DF_PackingList_Status] DEFAULT ('') NOT NULL,
    [INVNo]                 VARCHAR (25)    CONSTRAINT [DF_PackingList_INVNo] DEFAULT ('') NOT NULL,
    [GMTBookingLock]        VARCHAR (1)     CONSTRAINT [DF_PackingList_GMTBookingLock] DEFAULT ('') NOT NULL,
    [ShipPlanID]            VARCHAR (13)    CONSTRAINT [DF_PackingList_ShipPlanID] DEFAULT ('') NOT NULL,
    [PulloutDate]           DATE            NULL,
    [PulloutID]             VARCHAR (13)    CONSTRAINT [DF_PackingList_PulloutID] DEFAULT ('') NOT NULL,
    [ExpressID]             VARCHAR (13)    CONSTRAINT [DF_PackingList_ExpressID] DEFAULT ('') NOT NULL,
    [InspDate]              DATE            NULL,
    [InspStatus]            VARCHAR (10)    CONSTRAINT [DF_PackingList_InspStatus] DEFAULT ('') NOT NULL,
    [AddName]               VARCHAR (10)    CONSTRAINT [DF_PackingList_AddName] DEFAULT ('') NOT NULL,
    [AddDate]               DATETIME        NULL,
    [EditName]              VARCHAR (10)    CONSTRAINT [DF_PackingList_EditName] DEFAULT ('') NOT NULL,
    [EditDate]              DATETIME        NULL,
    [TransFerToClogID]      VARCHAR (13)    CONSTRAINT [DF_PackingList_TransFerToClogID] DEFAULT ('') NOT NULL,
    [ClogReceiveID]         VARCHAR (13)    CONSTRAINT [DF_PackingList_ClogReceiveID] DEFAULT ('') NOT NULL,
    [QueryDate]             DATE            NULL,
    [RepackFrom]            VARCHAR (13)    CONSTRAINT [DF_PackingList_RepackFrom] DEFAULT ('') NOT NULL,
    ...
    [OrderCompanyID]   NUMERIC(2, 0)      CONSTRAINT [DF_PackingList_OrderCompanyID] DEFAULT ((0)) NOT NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'該從姊妹廠接收到該PL的全部箱子時間', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'PackingList', @level2type = N'COLUMN', @level2name = N'PLCtnRecvFMRgCodeDate';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'訂單公司別', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'PackingList', @level2type = N'COLUMN', @level2name = N'OrderCompanyID';
