CREATE TABLE [dbo].[Pullout_Revise_Detail] (
    ...
    [UKey]         BIGINT       CONSTRAINT [DF_Pullout_Revise_Detail_UKey] DEFAULT ((0)) NOT NULL,
    [ReviseKey]    BIGINT       CONSTRAINT [DF_Pullout_Revise_Detail_ReviseKey] DEFAULT ((0)) NOT NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'UKey', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Pullout_Revise_Detail', @level2type = N'COLUMN', @level2name = N'UKey';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Revise Key', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Pullout_Revise_Detail', @level2type = N'COLUMN', @level2name = N'ReviseKey';
