CREATE TABLE [dbo].[SCIFty] (
    ...
    [AddressCH]     NVARCHAR (50)  CONSTRAINT [DF_SCIFty_AddressCH] DEFAULT ('') NOT NULL,
    [AddressEN]     NVARCHAR (MAX) CONSTRAINT [DF_SCIFty_AddressEN] DEFAULT ('') NOT NULL,
    [CurrencyID]    VARCHAR (3)    CONSTRAINT [DF_SCIFty_CurrencyID] DEFAULT ('') NOT NULL,
    [ExpressGroup]  VARCHAR (8)    CONSTRAINT [DF_SCIFty_ExpressGroup] DEFAULT ('') NOT NULL,
    [PortAir]       VARCHAR (20)   CONSTRAINT [DF_SCIFty_PortAir] DEFAULT ('') NOT NULL,
    [MDivisionID]   VARCHAR (8)    CONSTRAINT [DF_SCIFty_MDivisionID] DEFAULT ('') NOT NULL,
    [AddName]       VARCHAR (10)   CONSTRAINT [DF_SCIFty_AddName] DEFAULT ('') NOT NULL,
    [AddDate]       DATETIME       NULL,
    [EditName]      VARCHAR (10)   CONSTRAINT [DF_SCIFty_EditName] DEFAULT ('') NOT NULL,
    [EditDate]      DATETIME       NULL,
    [Type]          VARCHAR (1)    DEFAULT ('') NOT NULL,
    [Zone]          VARCHAR (6)    CONSTRAINT [DF_SCIFty_Zone] DEFAULT ('') NOT NULL,
    [FtyZone]       VARCHAR (8)    CONSTRAINT [DF_SCIFty_FtyZone] DEFAULT ('') NOT NULL,
    [IsSubcon]      BIT            DEFAULT ((0)) NOT NULL,
    [KPICode]       VARCHAR (8)    CONSTRAINT [DF_SCIFty_KPICode] DEFAULT ('') NULL,
    [ProduceRgCode] VARCHAR (3)    CONSTRAINT [DF_SCIFty_ProduceRgCode] DEFAULT ('') NOT NULL,
