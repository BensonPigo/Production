CREATE TABLE [dbo].[SampleGarmentTest_Detail_FGPT] (
    ...
    [Seq]                     INT            CONSTRAINT [DF_SampleGarmentTest_Detail_FGPT_Seq] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [PK_SampleGarmentTest_Detail_FGPT] PRIMARY KEY CLUSTERED ([ID] ASC, [No] ASC, [Location] ASC, [Type] ASC, [TestName] ASC, [Seq] ASC)
);
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'顯示順序', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SampleGarmentTest_Detail_FGPT', @level2type = N'COLUMN', @level2name = N'Seq';
