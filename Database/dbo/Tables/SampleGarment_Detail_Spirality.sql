...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Side Seam (%) side-panel (Method B)', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SampleGarment_Detail_Spirality', @level2type = N'COLUMN', @level2name = N'MethodB';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Body A (%) within-panel (Method A)', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SampleGarment_Detail_Spirality', @level2type = N'COLUMN', @level2name = N'MethodA';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Movement of side seam/outseam in CM', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SampleGarment_Detail_Spirality', @level2type = N'COLUMN', @level2name = N'CM';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'部位 (Top, Bottom)', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SampleGarment_Detail_Spirality', @level2type = N'COLUMN', @level2name = N'Location';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Garment_Detail.No', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SampleGarment_Detail_Spirality', @level2type = N'COLUMN', @level2name = N'No';
