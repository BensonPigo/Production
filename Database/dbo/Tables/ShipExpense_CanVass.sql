CREATE TABLE [dbo].[ShipExpense_CanVass] (
    ...
    [Price1]       NUMERIC (12, 4) CONSTRAINT [DF_ShipExpense_CanVass_Price1] DEFAULT ((0)) NULL,
    [Price2]       NUMERIC (12, 4) CONSTRAINT [DF_ShipExpense_CanVass_Price2] DEFAULT ((0)) NULL,
    [Price3]       NUMERIC (12, 4) CONSTRAINT [DF_ShipExpense_CanVass_Price3] DEFAULT ((0)) NULL,
    [Price4]       NUMERIC (12, 4) CONSTRAINT [DF_ShipExpense_CanVass_Price4] DEFAULT ((0)) NULL,
