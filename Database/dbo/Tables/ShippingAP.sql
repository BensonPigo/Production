...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'外帳傳票ID', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ShippingAP', @level2type = N'COLUMN', @level2name = N'ExVoucherID';
GO
