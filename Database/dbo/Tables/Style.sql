CREATE TABLE [dbo].[Style] (
    ...
    [Model]               VARCHAR (25)   CONSTRAINT [DF_Style_Model] DEFAULT ('') NOT NULL,
    [Description]         VARCHAR (100)  CONSTRAINT [DF_Style_Description] DEFAULT ('') NOT NULL,
    [StyleName]           NVARCHAR (50)  CONSTRAINT [DF_Style_StyleName] DEFAULT ('') NOT NULL,
    [ComboType]           VARCHAR (4)    CONSTRAINT [DF_Style_ComboType] DEFAULT ('') NOT NULL,
    ...
    [CPU]                 DECIMAL (5, 3) CONSTRAINT [DF_Style_CPU] DEFAULT ((0)) NOT NULL,
    [Factories]           NVARCHAR (200) CONSTRAINT [DF_Style_Factories] DEFAULT ('') NOT NULL,
    [FTYRemark]           NVARCHAR (MAX) CONSTRAINT [DF_Style_FTYRemark] DEFAULT ('') NOT NULL,
    [SampleSMR]           VARCHAR (10)   CONSTRAINT [DF_Style_SampleSMR] DEFAULT ('') NOT NULL,
    [SampleMRHandle]      VARCHAR (10)   CONSTRAINT [DF_Style_SampleMRHandle] DEFAULT ('') NOT NULL,
    [BulkSMR]             VARCHAR (10)   CONSTRAINT [DF_Style_BulkSMR] DEFAULT ('') NOT NULL,
    [BulkMRHandle]        VARCHAR (10)   CONSTRAINT [DF_Style_BulkMRHandle] DEFAULT ('') NOT NULL,
    [Junk]                BIT            CONSTRAINT [DF_Style_Junk] DEFAULT ((0)) NOT NULL,
    [RainwearTestPassed]  BIT            CONSTRAINT [DF_Style_RainwearTestPassed] DEFAULT ((0)) NOT NULL,
    [SizePage]            VARCHAR (2)    CONSTRAINT [DF_Style_SizePage] DEFAULT ('') NOT NULL,
    [SizeRange]           NVARCHAR (MAX) CONSTRAINT [DF_Style_SizeRange] DEFAULT ('') NOT NULL,
    [CTNQty]              SMALLINT       CONSTRAINT [DF_Style_CTNQty] DEFAULT ((0)) NOT NULL,
    [StdCost]             DECIMAL (7, 2) CONSTRAINT [DF_Style_StdCost] DEFAULT ((0)) NOT NULL,
    [Processes]           NVARCHAR (60)  CONSTRAINT [DF_Style_Processes] DEFAULT ('') NOT NULL,
    [ArtworkCost]         VARCHAR (1)    CONSTRAINT [DF_Style_ArtworkCost] DEFAULT ('') NOT NULL,
    [Picture1]            NVARCHAR (60)  CONSTRAINT [DF_Style_Picture1] DEFAULT ('') NOT NULL,
    [Picture2]            NVARCHAR (60)  CONSTRAINT [DF_Style_Picture2] DEFAULT ('') NOT NULL,
    [Label]               NVARCHAR (MAX) CONSTRAINT [DF_Style_Label] DEFAULT ('') NOT NULL,
    [Packing]             NVARCHAR (MAX) CONSTRAINT [DF_Style_Packing] DEFAULT ('') NOT NULL,
    [IETMSID]             VARCHAR (10)   CONSTRAINT [DF_Style_IETMSID] DEFAULT ('') NOT NULL,
    [IETMSVersion]        VARCHAR (3)    CONSTRAINT [DF_Style_IETMSVersion] DEFAULT ('') NOT NULL,
    [IEImportName]        VARCHAR (10)   CONSTRAINT [DF_Style_IEImportName] DEFAULT ('') NOT NULL,
    [IEImportDate]        DATETIME       NULL,
    [ApvDate]             DATETIME       NULL,
    [ApvName]             VARCHAR (10)   CONSTRAINT [DF_Style_ApvName] DEFAULT ('') NOT NULL,
    [CareCode]            VARCHAR (10)   CONSTRAINT [DF_Style_CareCode] DEFAULT ('') NOT NULL,
    [SpecialMark]         VARCHAR (5)    CONSTRAINT [DF_Style_SpecialMark] DEFAULT ('') NOT NULL,
    [Lining]              VARCHAR (20)   CONSTRAINT [DF_Style_Lining] DEFAULT ('') NOT NULL,
    [StyleUnit]           VARCHAR (8)    CONSTRAINT [DF_Style_StyleUnit] DEFAULT ('') NOT NULL,
    [ExpectionForm]       BIT            CONSTRAINT [DF_Style_ExpectionForm] DEFAULT ((0)) NOT NULL,
    [ExpectionFormRemark] NVARCHAR (MAX) CONSTRAINT [DF_Style_ExpectionFormRemark] DEFAULT ('') NOT NULL,
    [LocalMR]             VARCHAR (10)   CONSTRAINT [DF_Style_LocalMR] DEFAULT ('') NOT NULL,
    [LocalStyle]          BIT            CONSTRAINT [DF_Style_LocalStyle] DEFAULT ((0)) NOT NULL,
    [PPMeeting]           DATE           NULL,
    [NoNeedPPMeeting]     BIT            CONSTRAINT [DF_Style_NoNeedPPMeeting] DEFAULT ((0)) NOT NULL,
    [SampleApv]           DATETIME       NULL,
    [AddName]             VARCHAR (10)   CONSTRAINT [DF_Style_AddName] DEFAULT ('') NOT NULL,
    [AddDate]             DATETIME       NULL,
    [EditName]            VARCHAR (10)   CONSTRAINT [DF_Style_EditName] DEFAULT ('') NOT NULL,
    [EditDate]            DATETIME       NULL,
    [SizeUnit]            VARCHAR (8)    CONSTRAINT [DF_Style_SizeUnit] DEFAULT ('') NOT NULL,
    [ModularParent]       VARCHAR (20)   CONSTRAINT [DF_Style_ModularParent] DEFAULT ('') NOT NULL,
    [CPUAdjusted]         DECIMAL (6, 4) CONSTRAINT [DF_Style_CPUAdjusted] DEFAULT ((0)) NOT NULL,
    [Phase]               VARCHAR (10)   CONSTRAINT [DF_Style_Phase] DEFAULT ('') NOT NULL,
    [Gender]              VARCHAR (10)   CONSTRAINT [DF_Style_Gender] DEFAULT ('') NOT NULL,
    [ThreadEditname]      VARCHAR (10)   CONSTRAINT [DF_Style_ThreadEditname] DEFAULT ('') NOT NULL,
    [ThreadEditdate]      DATETIME       NULL,
    [ThickFabric]         BIT            CONSTRAINT [DF_Style_ThickFabric] DEFAULT ((0)) NOT NULL,
    [DyeingID]            VARCHAR (5)    CONSTRAINT [DF_Style_DyeingID] DEFAULT ('') NOT NULL,
    [TPEEditName]         VARCHAR (10)   CONSTRAINT [DF_Style_TPEEditName] DEFAULT ('') NOT NULL,
    [TPEEditDate]         DATETIME       NULL,
    [Pressing1]           INT            CONSTRAINT [DF_Style_Pressing1] DEFAULT ((0)) NOT NULL,
    [Pressing2]           INT            CONSTRAINT [DF_Style_Pressing2] DEFAULT ((0)) NOT NULL,
    [Folding1]            INT            CONSTRAINT [DF_Style_Folding1] DEFAULT ((0)) NOT NULL,
    [Folding2]            INT            CONSTRAINT [DF_Style_Folding2] DEFAULT ((0)) NOT NULL,
    [ExpectionFormStatus] VARCHAR (1)    CONSTRAINT [DF_Style_ExpectionFormStatus] DEFAULT ('') NOT NULL,
    [ExpectionFormDate]   DATE           NULL,
    [ThickFabricBulk]     BIT            CONSTRAINT [DF_Style_ThickFabricBulk] DEFAULT ((0)) NOT NULL,
    [HangerPack]          BIT            CONSTRAINT [DF_Style_HangerPack] DEFAULT ((0)) NOT NULL,
    [Construction]        VARCHAR (1)    CONSTRAINT [DF_Style_Construction] DEFAULT ('') NOT NULL,
    [CDCodeNew]           VARCHAR (5)    CONSTRAINT [DF_Style_CDCodeNew] DEFAULT ('') NOT NULL,
    [FitType]             VARCHAR (50)   CONSTRAINT [DF_Style_FitType] DEFAULT ('') NOT NULL,
    [GearLine]            VARCHAR (50)   CONSTRAINT [DF_Style_GearLine] DEFAULT ('') NOT NULL,
    [ThreadVersion]       VARCHAR (5)    CONSTRAINT [DF_Style_ThreadVersion] DEFAULT ('') NOT NULL,
    [DevRegion]           VARCHAR (2)    CONSTRAINT [DF_Style_DevRegion] DEFAULT ('') NOT NULL,
    [DevOption]           BIT            CONSTRAINT [DF_Style_DevOption] DEFAULT ((0)) NOT NULL,
    [Teamwear]            BIT            CONSTRAINT [DF_Style_Teamwear] DEFAULT ((0)) NOT NULL,
    [NEWCO]               VARCHAR (1)    DEFAULT ('') NOT NULL,
    [BrandGender]         VARCHAR (10)   DEFAULT ('') NOT NULL,
