...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Garment L/T', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Style_Article', @level2type = N'COLUMN', @level2name = N'GarmentLT';
