CREATE TABLE [dbo].[Style_Artwork] (
    ...
    [PatternCode]   VARCHAR (10)   CONSTRAINT [DF_Style_Artwork_PatternCode] DEFAULT ('') NULL,
    [PatternDesc]   NVARCHAR (40)  CONSTRAINT [DF_Style_Artwork_PatternDesc] DEFAULT ('') NULL,
    ...
    [Ukey]          BIGINT         CONSTRAINT [DF_Style_Artwork_Ukey] DEFAULT ((0)) NOT NULL,
