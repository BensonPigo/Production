CREATE TABLE [dbo].[Style_FabricCode_Article] (
    ...
    [FabricPanelCode]    VARCHAR (2)  CONSTRAINT [DF_Style_FabricCode_Article_FabricPanelCode] DEFAULT ('') NOT NULL,
    ...
    CONSTRAINT [PK_Style_FabricCode_Article] PRIMARY KEY CLUSTERED ([Style_BOFUkey] ASC, [FabricPanelCode] ASC, [Article] ASC)
);
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'布別+部位的代碼', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Style_FabricCode_Article', @level2type = N'COLUMN', @level2name = N'FabricPanelCode';
