CREATE TABLE [dbo].[Style_MarkerList] (
    [StyleUkey]           BIGINT          CONSTRAINT [DF_Style_MarkerList_StyleUkey] DEFAULT ((0)) NOT NULL,
    [Ukey]                BIGINT          CONSTRAINT [DF_Style_MarkerList_Ukey] DEFAULT ((0)) NOT NULL,
    [Seq]                 SMALLINT        CONSTRAINT [DF_Style_MarkerList_Seq] DEFAULT ((0)) NOT NULL,
    [MarkerName]          NVARCHAR (20)   CONSTRAINT [DF_Style_MarkerList_MarkerName] DEFAULT ('') NOT NULL,
    [FabricCode]          VARCHAR (3)     CONSTRAINT [DF_Style_MarkerList_FabricCode] DEFAULT ('') NOT NULL,
    [FabricCombo]         VARCHAR (2)     CONSTRAINT [DF_Style_MarkerList_FabricCombo] DEFAULT ('') NOT NULL,
    [FabricPanelCode]     VARCHAR (2)     CONSTRAINT [DF_Style_MarkerList_FabricPanelCode] DEFAULT ('') NOT NULL,
    [MarkerLength]        VARCHAR (15)    CONSTRAINT [DF_Style_MarkerList_MarkerLength] DEFAULT ('') NOT NULL,
    [ConsPC]              DECIMAL (12, 4) CONSTRAINT [DF_Style_MarkerList_ConsPC] DEFAULT ((0)) NOT NULL,
    [CuttingPiece]        BIT             CONSTRAINT [DF_Style_MarkerList_CuttingPiece] DEFAULT ((0)) NOT NULL,
    [ActCuttingPerimeter] NVARCHAR (15)   CONSTRAINT [DF_Style_MarkerList_ActCuttingPerimeter] DEFAULT ('') NOT NULL,
    [StraightLength]      VARCHAR (15)    CONSTRAINT [DF_Style_MarkerList_StraightLength] DEFAULT ('') NOT NULL,
    [CurvedLength]        VARCHAR (15)    CONSTRAINT [DF_Style_MarkerList_CurvedLength] DEFAULT ('') NOT NULL,
    [Efficiency]          VARCHAR (9)     CONSTRAINT [DF_Style_MarkerList_Efficiency] DEFAULT ('') NOT NULL,
    [Remark]              NVARCHAR (250)  CONSTRAINT [DF_Style_MarkerList_Remark] DEFAULT ('') NOT NULL,
    [MixedSizeMarker]     VARCHAR (1)     CONSTRAINT [DF_Style_MarkerList_MixedSizeMarker] DEFAULT ('') NOT NULL,
    [MarkerNo]            VARCHAR (10)    CONSTRAINT [DF_Style_MarkerList_MarkerNo] DEFAULT ('') NOT NULL,
    [MarkerUpdate]        DATETIME        NULL,
    [MarkerUpdateName]    VARCHAR (10)    CONSTRAINT [DF_Style_MarkerList_MarkerUpdateName] DEFAULT ('') NOT NULL,
    [AllSize]             BIT             CONSTRAINT [DF_Style_MarkerList_AllSize] DEFAULT ((0)) NOT NULL,
    [PhaseID]             VARCHAR (10)    CONSTRAINT [DF_Style_MarkerList_PhaseID] DEFAULT ('') NOT NULL,
    [SMNoticeID]          VARCHAR (10)    CONSTRAINT [DF_Style_MarkerList_SMNoticeID] DEFAULT ('') NOT NULL,
    [MarkerVersion]       VARCHAR (3)     CONSTRAINT [DF_Style_MarkerList_MarkerVersion] DEFAULT ('') NOT NULL,
    [Direction]           NVARCHAR (40)   CONSTRAINT [DF_Style_MarkerList_Direction] DEFAULT ('') NOT NULL,
    [CuttingWidth]        VARCHAR (8)     CONSTRAINT [DF_Style_MarkerList_CuttingWidth] DEFAULT ('') NOT NULL,
    [Width]               VARCHAR (6)     CONSTRAINT [DF_Style_MarkerList_Width] DEFAULT ('') NOT NULL,
    [Type]                VARCHAR (1)     CONSTRAINT [DF_Style_MarkerList_Type] DEFAULT ('') NOT NULL,
    [AddName]             VARCHAR (10)    CONSTRAINT [DF_Style_MarkerList_AddName] DEFAULT ('') NOT NULL,
    [AddDate]             DATETIME        NULL,
    [EditName]            VARCHAR (10)    CONSTRAINT [DF_Style_MarkerList_EditName] DEFAULT ('') NOT NULL,
