CREATE TABLE [dbo].[SubTransferLocal_Detail] (
    ...
    [FromLocation] VARCHAR (100)   CONSTRAINT [DF__SubTransf__FromL__1CD2EB5D] DEFAULT ('') NOT NULL,
    [ToLocation]   VARCHAR (100)   CONSTRAINT [DF__SubTransf__ToLoc__1DC70F96] DEFAULT ('') NOT NULL,
