CREATE TABLE [dbo].[SubTransfer_Detail] (
    ...
    [FromBalanceQty]       NUMERIC (11, 2) CONSTRAINT [DF_SubTransfer_Detail_FromBalanceQty] DEFAULT ((0)) NOT NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'轉出後剩下多少庫存', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'SubTransfer_Detail', @level2type = N'COLUMN', @level2name = N'FromBalanceQty';
