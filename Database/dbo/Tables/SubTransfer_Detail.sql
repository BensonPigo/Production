CREATE TABLE [dbo].[SubTransfer_Detail] (
    ...
    [FromStockType]        VARCHAR        CONSTRAINT [DF_SubTransfer_Detail_FromStockType] DEFAULT ('') NOT NULL,
    ...
    [ToStockType]          VARCHAR        CONSTRAINT [DF_SubTransfer_Detail_ToStockType] DEFAULT ('') NOT NULL,
