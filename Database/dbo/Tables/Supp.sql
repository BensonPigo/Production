CREATE TABLE [dbo].[Supp] (
    ...
    [Junk]            BIT            CONSTRAINT [DF_Supp_Junk] DEFAULT ((0)) NOT NULL,
    [AbbCH]           NVARCHAR (12)  CONSTRAINT [DF_Supp_AbbCH] DEFAULT ('') NOT NULL,
    [AbbEN]           VARCHAR (12)   CONSTRAINT [DF_Supp_AbbEN] DEFAULT ('') NOT NULL,
    [NameCH]          NVARCHAR (75)  CONSTRAINT [DF_Supp_NameCH] DEFAULT ('') NOT NULL,
    [NameEN]          NVARCHAR (75)  CONSTRAINT [DF_Supp_NameEN] DEFAULT ('') NOT NULL,
    [CountryID]       VARCHAR (2)    CONSTRAINT [DF_Supp_CountryID] DEFAULT ('') NOT NULL,
    [ThirdCountry]    BIT            CONSTRAINT [DF_Supp_ThirdCountry] DEFAULT ((0)) NOT NULL,
    [Tel]             VARCHAR (30)   CONSTRAINT [DF_Supp_Tel] DEFAULT ('') NOT NULL,
    [Fax]             VARCHAR (30)   CONSTRAINT [DF_Supp_Fax] DEFAULT ('') NOT NULL,
    [AddressCH]       NVARCHAR (100) CONSTRAINT [DF_Supp_AddressCH] DEFAULT ('') NOT NULL,
    [AddressEN]       NVARCHAR (MAX) CONSTRAINT [DF_Supp_AddressEN] DEFAULT ('') NOT NULL,
    [ZipCode]         VARCHAR (10)   CONSTRAINT [DF_Supp_ZipCode] DEFAULT ('') NOT NULL,
    [Delay]           DATE           NULL,
    [DelayMemo]       NVARCHAR (MAX) CONSTRAINT [DF_Supp_DelayMemo] DEFAULT ('') NOT NULL,
    [LockDate]        DATE           NULL,
    [LockMemo]        NVARCHAR (MAX) CONSTRAINT [DF_Supp_LockMemo] DEFAULT ('') NOT NULL,
    [AddName]         VARCHAR (10)   CONSTRAINT [DF_Supp_AddName] DEFAULT ('') NOT NULL,
    [AddDate]         DATETIME       NULL,
    [EditName]        VARCHAR (10)   CONSTRAINT [DF_Supp_EditName] DEFAULT ('') NOT NULL,
    [EditDate]        DATETIME       NULL,
    [Currencyid]      VARCHAR (3)    CONSTRAINT [DF_Supp_Currencyid] DEFAULT ('') NOT NULL,
