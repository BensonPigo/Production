CREATE TABLE [dbo].[ThreadRequisition_Detail_Cons] (
    ...
    [Colorid]                      VARCHAR (6)    CONSTRAINT [DF_ThreadRequisition_Detail_Cons_Colorid] DEFAULT ('') NULL,
    ...
    [ThreadLocationID]             VARCHAR (4)    CONSTRAINT [DF_ThreadRequisition_Detail_Cons_ThreadLocationID] DEFAULT ('') NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'布顏色', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ThreadRequisition_Detail_Cons', @level2type = N'COLUMN', @level2name = N'Colorid';
