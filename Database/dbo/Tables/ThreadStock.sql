CREATE TABLE [dbo].[ThreadStock] (
    [Refno]            VARCHAR (20) CONSTRAINT [DF_ThreadStock_Refno] DEFAULT ('') NOT NULL,
    ...
    CONSTRAINT [PK_ThreadStock] PRIMARY KEY CLUSTERED ([Refno] ASC, [ThreadColorID] ASC, [ThreadLocationID] ASC)
);
