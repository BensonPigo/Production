CREATE TABLE [dbo].[Unit_Rate] (
    ...
    [Rate]        VARCHAR (22)     CONSTRAINT [DF_Unit_Rate_Rate] DEFAULT ('') NOT NULL,
    [RateValue]   DECIMAL (28, 18) CONSTRAINT [DF_Unit_Rate_RateValue] DEFAULT ((0)) NOT NULL,
    [AddName]     VARCHAR (10)     CONSTRAINT [DF_Unit_Rate_AddName] DEFAULT ('') NOT NULL,
    [AddDate]     DATETIME         NULL,
    [EditName]    VARCHAR (10)     CONSTRAINT [DF_Unit_Rate_EditName] DEFAULT ('') NOT NULL,
