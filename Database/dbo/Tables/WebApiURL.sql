...
(
    ...
    [Junk] BIT NOT NULL CONSTRAINT [DF_WebApiURL_Junk] DEFAULT (0), 
    [ModuleType] VARCHAR(20) NOT NULL CONSTRAINT [DF_WebApiURL_Type] DEFAULT ('') , 
    CONSTRAINT [PK_WebApiURL] PRIMARY KEY CLUSTERED ([SuppID], [ModuleName], [ModuleType] ASC)
)
