CREATE TABLE [dbo].[WorkOrder] (
    ...
    [CutRef]                  VARCHAR (6)    CONSTRAINT [DF_WorkOrder_CutRef] DEFAULT ('') NOT NULL,
    [OrderID]                 VARCHAR (13)   CONSTRAINT [DF_WorkOrder_OrderID] DEFAULT ('') NOT NULL,
    [CutplanID]               VARCHAR (13)   CONSTRAINT [DF_WorkOrder_CutplanID] DEFAULT ('') NOT NULL,
    [Cutno]                   DECIMAL (6)    CONSTRAINT [DF_WorkOrder_Cutno] DEFAULT ((0)) NOT NULL,
    [Layer]                   DECIMAL (5)    CONSTRAINT [DF_WorkOrder_Layer] DEFAULT ((0)) NOT NULL,
    [Colorid]                 VARCHAR (6)    CONSTRAINT [DF_WorkOrder_Colorid] DEFAULT ('') NOT NULL,
    [Markername]              VARCHAR (20)   CONSTRAINT [DF_WorkOrder_Markername] DEFAULT ('') NOT NULL,
    [EstCutDate]              DATE           NULL,
    [CutCellid]               VARCHAR (2)    CONSTRAINT [DF_WorkOrder_CutCellid] DEFAULT ('') NOT NULL,
    [MarkerLength]            VARCHAR (15)   CONSTRAINT [DF_WorkOrder_MarkerLength] DEFAULT ('') NOT NULL,
    [ConsPC]                  DECIMAL (6, 4) CONSTRAINT [DF_WorkOrder_ConsPC] DEFAULT ((0)) NOT NULL,
    [Cons]                    DECIMAL (9, 4) CONSTRAINT [DF_WorkOrder_Cons] DEFAULT ((0)) NOT NULL,
    [Refno]                   VARCHAR (36)   CONSTRAINT [DF_WorkOrder_Refno] DEFAULT ('') NOT NULL,
    [SCIRefno]                VARCHAR (30)   CONSTRAINT [DF_WorkOrder_SCIRefno] DEFAULT ('') NOT NULL,
    [MarkerNo]                VARCHAR (10)   CONSTRAINT [DF_WorkOrder_MarkerNo] DEFAULT ('') NOT NULL,
    [MarkerVersion]           VARCHAR (3)    CONSTRAINT [DF_WorkOrder_MarkerVersion] DEFAULT ('') NOT NULL,
    [Ukey]                    BIGINT         IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    [Type]                    VARCHAR (1)    CONSTRAINT [DF_WorkOrder_Type] DEFAULT ('') NOT NULL,
    [AddName]                 VARCHAR (10)   CONSTRAINT [DF_WorkOrder_AddName] DEFAULT ('') NOT NULL,
    [AddDate]                 DATETIME       NULL,
    [EditName]                VARCHAR (10)   CONSTRAINT [DF_WorkOrder_EditName] DEFAULT ('') NOT NULL,
    [EditDate]                DATETIME       NULL,
    [FabricCombo]             VARCHAR (2)    CONSTRAINT [DF_WorkOrder_FabricCombo] DEFAULT ('') NOT NULL,
    [MarkerDownLoadId]        VARCHAR (25)   CONSTRAINT [DF_WorkOrder_MarkerDownLoadId] DEFAULT ('') NOT NULL,
    [FabricCode]              VARCHAR (3)    CONSTRAINT [DF_WorkOrder_FabricCode] DEFAULT ('') NOT NULL,
    [FabricPanelCode]         VARCHAR (2)    CONSTRAINT [DF_WorkOrder_FabricPanelCode] DEFAULT ('') NOT NULL,
    [Order_EachconsUkey]      BIGINT         CONSTRAINT [DF_WorkOrder_Order_EachconsUkey] DEFAULT ((0)) NOT NULL,
    [OldFabricUkey]           VARCHAR (10)   CONSTRAINT [DF_WorkOrder_OldFabricUkey] DEFAULT ('') NOT NULL,
    [OldFabricVer]            VARCHAR (2)    CONSTRAINT [DF_WorkOrder_OldFabricVer] DEFAULT ('') NOT NULL,
    [ActCuttingPerimeter]     NVARCHAR (15)  CONSTRAINT [DF_WorkOrder_ActCuttingPerimeter] DEFAULT ('') NOT NULL,
    [StraightLength]          VARCHAR (15)   CONSTRAINT [DF_WorkOrder_StraightLength] DEFAULT ('') NOT NULL,
    [CurvedLength]            VARCHAR (15)   CONSTRAINT [DF_WorkOrder_CurvedLength] DEFAULT ('') NOT NULL,
    [SpreadingNoID]           VARCHAR (5)    CONSTRAINT [DF_WorkOrder_SpreadingNoID] DEFAULT ('') NOT NULL,
