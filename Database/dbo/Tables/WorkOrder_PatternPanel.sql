CREATE TABLE [dbo].[WorkOrder_PatternPanel] (
    ...
    [FabricPanelCode]    VARCHAR (2)  CONSTRAINT [DF_WorkOrder_PatternPanel_FabricPanelCode] DEFAULT ('') NOT NULL,
    CONSTRAINT [PK_WorkOrder_PatternPanel] PRIMARY KEY CLUSTERED ([WorkOrderUkey] ASC, [PatternPanel] ASC, [FabricPanelCode] ASC)
);
