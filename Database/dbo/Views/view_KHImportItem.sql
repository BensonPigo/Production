...
FROM              
(	SELECT          SCIRefno AS Refno, DescDetail AS Description, 
	(CASE Type WHEN 'F' THEN 'Fabric' ELSE 'Accessory' END) AS CustomsType, UsageUnit AS Unit, 
	Junk
	FROM               dbo.Fabric
	WHERE           (Type IN ('F', 'A'))
	UNION ALL
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'view_KHImportItem';
