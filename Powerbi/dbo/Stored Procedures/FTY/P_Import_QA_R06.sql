...
BEGIN
	...
	SELECT * INTO #View_AllReceivingDetail 	FROM [MainServer].Production.dbo.View_AllReceivingDetail WHERE WhseArrival >= '2019/01/01';

	SELECT * INTO #SubTransfer FROM [MainServer].Production.dbo.SubTransfer WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #BorrowBack FROM [MainServer].Production.dbo.BorrowBack WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #Orders FROM [MainServer].Production.dbo.Orders WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #Fabric FROM [MainServer].Production.dbo.Fabric WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');
	
	SELECT * INTO #PO_Supp FROM [MainServer].Production.dbo.PO_Supp WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #Supp FROM [MainServer].Production.dbo.Supp ;--WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #FIR FROM [MainServer].Production.dbo.FIR WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #FIR_Physical FROM [MainServer].Production.dbo.FIR_Physical WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #Fir_shadebone FROM [MainServer].Production.dbo.Fir_shadebone WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #Oven FROM [MainServer].Production.dbo.Oven WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #ColorFastness FROM [MainServer].Production.dbo.ColorFastness WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');
	...
	SELECT * INTO #FIR_Continuity FROM [MainServer].Production.dbo.FIR_Continuity WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #FIR_Laboratory_Wash FROM [MainServer].Production.dbo.FIR_Laboratory_Wash WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #Export FROM [MainServer].Production.dbo.Export WHERE (AddDate >= '2019/01/01' OR EditDate >= '2019/01/01');

	SELECT * INTO #SentReport FROM [MainServer].Production.dbo.SentReport WHERE (InspectionReport >= '2019/01/01' OR 
