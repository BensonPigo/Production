	...
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'採購交期' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'P_FabricInspReport_ReceivingTransferIn_History', @level2type=N'COLUMN',@level2name=N'Buyerdelivery'
	go
