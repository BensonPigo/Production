CREATE TABLE [dbo].[P_ImportScheduleList] (
    ...
    [ContainerType]        VARCHAR (100)   CONSTRAINT [DF_P_ImportScheduleList_ContainerType] DEFAULT ('') NOT NULL,
    [ContainerNo]          VARCHAR (100)   CONSTRAINT [DF_P_ImportScheduleList_ContainerNo] DEFAULT ('') NOT NULL,
