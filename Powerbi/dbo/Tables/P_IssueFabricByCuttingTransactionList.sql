...
(
    ...
    [ColorID] VARCHAR(6) CONSTRAINT [DF_P_IssueFabricByCuttingTransactionList_ColorID]     NOT NULL DEFAULT (('')), 
    ...
    [IssueCreateName] VARCHAR(50) CONSTRAINT [DF_P_IssueFabricByCuttingTransactionList_IssueCreateName]     NOT NULL DEFAULT (('')), 
    [MINDReleaseName] VARCHAR(50) CONSTRAINT [DF_P_IssueFabricByCuttingTransactionList_MINDReleaseName]     NOT NULL DEFAULT (('')), 
    ...
    [UnrollScanName] VARCHAR(50) CONSTRAINT [DF_P_IssueFabricByCuttingTransactionList_UnrollScanName]     NOT NULL DEFAULT (('')), 
    [UnrollStartTime] DATETIME  NULL, 
    [UnrollEndTime] DATETIME  NULL, 
    [RelaxationStartTime] DATETIME NULL, 
    [RelaxationEndTime] DATETIME NULL, 
    [UnrollActualQty] NUMERIC(5, 2) CONSTRAINT [DF_P_IssueFabricByCuttingTransactionList_UnrollActualQty]     NOT NULL DEFAULT ((0)), 
    ...
    [DispatchScanName] VARCHAR(50) CONSTRAINT [DF_P_IssueFabricByCuttingTransactionList_DispatchScanName]     NOT NULL DEFAULT (('')), 
    [DispatchScanTime] DATETIME NULL, 
    [RegisterTime] DATETIME NULL, 
    [DispatchTime] DATETIME NULL, 
    [FactoryReceivedName] VARCHAR(50) CONSTRAINT [DF_P_IssueFabricByCuttingTransactionList_FactoryReceivedName]     NOT NULL DEFAULT (('')), 
    [FactoryReceivedTime] DATETIME NULL, 
    [AddDate] DATETIME NULL, 
    [EditDate] DATETIME NULL, 
    CONSTRAINT [PK_P_IssueFabricByCuttingTransactionList] PRIMARY KEY ([IssueID], [OrderID], [Seq], [StockType], [Roll], [Dyelot])
)
