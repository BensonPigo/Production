CREATE TABLE [dbo].[P_SewingDailyOutputStatusRecord] (
    ...
    [Article]              VARCHAR (100)   CONSTRAINT [DF_P_SewingDailyOutputStatusRecord_Article] DEFAULT ('') NOT NULL,
    ...
    [Artwork]              VARCHAR (15)    CONSTRAINT [DF_P_SewingDailyOutputStatusRecord_Artwork] DEFAULT ('') NOT NULL,
    [JITDate]              DATE            NULL,
    [BCSDate]              DATE            NULL,
    ...
    [Consumption]          DECIMAL (9, 4)  CONSTRAINT [DF_P_SewingDailyOutputStatusRecord_Consumption] DEFAULT ((0)) NOT NULL,
    [ActConsOutput]        NUMERIC (9, 4)  CONSTRAINT [DF_P_SewingDailyOutputStatusRecord_ActConsOutput] DEFAULT ((0)) NOT NULL,
