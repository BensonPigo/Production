...
ALTER TABLE [dbo].[P_StyleChangeover] ADD  CONSTRAINT [DF_P_StyleChangeover_Factory]  DEFAULT ('') FOR [FactoryID]
GO
...
ALTER TABLE [dbo].[P_StyleChangeover] ADD  CONSTRAINT [DF_P_StyleChangeover_BIFactoryID]  DEFAULT ('') FOR [BIFactoryID]
GO
