...
ALTER TABLE [dbo].[P_SubProInsReport] ADD  CONSTRAINT [DF_P_SubProInsReport_OpreatorID]  DEFAULT ('') FOR [OperatorID]
GO

ALTER TABLE [dbo].[P_SubProInsReport] ADD  CONSTRAINT [DF_P_SubProInsReport_OperatorName]  DEFAULT ('') FOR [OperatorName]
GO

ALTER TABLE [dbo].[P_SubProInsReport] ADD  CONSTRAINT [DF_P_SubProInsReport_BIFactoryID]  DEFAULT ('') FOR [BIFactoryID]
GO
