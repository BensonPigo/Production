CREATE TABLE [dbo].[P_WIP](
	...
	[TTLCPU] [numeric](9, 3) NOT NULL,
	[CPUClosed] [numeric](9, 3) NOT NULL,
	[CPUBal] [numeric](9, 3) NOT NULL,
	[Article] [nvarchar](100) NOT NULL,
	[Qty] [int] NOT NULL,
	[StandardOutput] [nvarchar](100) NOT NULL,
	[OrigArtwork] [nvarchar](200) NOT NULL,
	[AddedArtwork] [nvarchar](200) NOT NULL,
	[BundleArtwork] [nvarchar](200) NOT NULL,
	[SubProcessDest] [nvarchar](300) NOT NULL,
	[EstCutDate] [date] NULL,
	[1stCutDate] [date] NULL,
	[CutQty] [numeric](10, 2) NOT NULL,
	[RFIDCutQty] [numeric](6, 0) NOT NULL,
	[RFIDSewingLineInQty] [numeric](6, 0) NOT NULL,
	[RFIDLoadingQty] [numeric](6, 0) NOT NULL,
	[RFIDEmbFarmInQty] [numeric](6, 0) NOT NULL,
	[RFIDEmbFarmOutQty] [numeric](6, 0) NOT NULL,
	[RFIDBondFarmInQty] [numeric](6, 0) NOT NULL,
	[RFIDBondFarmOutQty] [numeric](6, 0) NOT NULL,
	[RFIDPrintFarmInQty] [numeric](6, 0) NOT NULL,
	[RFIDPrintFarmOutQty] [numeric](6, 0) NOT NULL,
	[RFIDATFarmInQty] [numeric](6, 0) NOT NULL,
	[RFIDATFarmOutQty] [numeric](6, 0) NOT NULL,
	[RFIDPadPrintFarmInQty] [numeric](6, 0) NOT NULL,
	[RFIDPadPrintFarmOutQty] [numeric](6, 0) NOT NULL,
	[RFIDEmbossDebossFarmInQty] [numeric](6, 0) NOT NULL,
	[RFIDEmbossDebossFarmOutQty] [numeric](6, 0) NOT NULL,
	[RFIDHTFarmInQty] [numeric](6, 0) NOT NULL,
	[RFIDHTFarmOutQty] [numeric](6, 0) NOT NULL,
	[SubProcessStatus] [varchar](1) NOT NULL,
	[EmbQty] [numeric](6, 0) NOT NULL,
	[BondQty] [numeric](6, 0) NOT NULL,
	[PrintQty] [numeric](6, 0) NOT NULL,
	[SewQty] [numeric](6, 0) NOT NULL,
	[SewBal] [numeric](6, 0) NOT NULL,
	[1stSewDate] [date] NULL,
	[LastSewDate] [date] NULL,
	[AverageDailyOutput] [int] NOT NULL,
	[EstOfflinedate] [date] NULL,
	[ScannedQty] [int] NOT NULL,
	[PackedRate] [numeric](5, 2) NOT NULL,
	[TTLCTN] [int] NOT NULL,
	[FtyCTN] [int] NOT NULL,
	[cLogCTN] [int] NOT NULL,
	[CFACTN] [int] NOT NULL,
	[InspDate] [varchar](100) NOT NULL,
	[InspResult] [varchar](16) NOT NULL,
	[CFAName] [nvarchar](100) NOT NULL,
	[ActPulloutDate] [date] NULL,
	[KPIDeliveryDate] [datetime] NULL,
	[UpdateDeliveryReason] [nvarchar](500) NOT NULL,
	[PlanDate] [date] NULL,
	[SMR] [varchar](45) NOT NULL,
	[Handle] [varchar](45) NOT NULL,
	[Posmr] [varchar](45) NOT NULL,
	[PoHandle] [varchar](45) NOT NULL,
	[MCHandle] [varchar](45) NOT NULL,
...
ALTER TABLE [dbo].[P_WIP] ADD  CONSTRAINT [DF_P_WIP_BIFactoryID]  DEFAULT ('') FOR [BIFactoryID]
GO
