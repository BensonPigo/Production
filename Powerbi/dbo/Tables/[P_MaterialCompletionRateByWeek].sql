CREATE TABLE P_MaterialCompletionRateByWeek
(
Year int NOT NULL,
WeekNo int NOT NULL,
...
GO
	...
	GO
	ALTER TABLE [dbo].[P_MaterialCompletionRateByWeek] ADD  CONSTRAINT [DF_P_CFAMasterListRelatedrate_WeekNoP]  DEFAULT ((0)) FOR [WeekNo]
	GO
	ALTER TABLE [dbo].[P_MaterialCompletionRateByWeek] ADD  CONSTRAINT [DF_P_CFAMasterListRelatedrate_FactoryID]  DEFAULT (('')) FOR [FactoryID]
	GO
	ALTER TABLE [dbo].[P_MaterialCompletionRateByWeek] ADD  CONSTRAINT [DF_P_CFAMasterListRelatedrate_MaterialCompletionRate]  DEFAULT ((0)) FOR [MaterialCompletionRate]
	GO
	...
	GO
	ALTER TABLE [dbo].[P_MaterialCompletionRateByWeek] ADD  CONSTRAINT [DF_P_CFAMasterListRelatedrate_TTLSPNo]  DEFAULT ((0)) FOR [TTLSPNo]
	GO
