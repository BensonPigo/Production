CREATE TABLE [dbo].[ArtworkType_FTY](
	...
	[IsShowinIEP01] [bit] NOT NULL,
	[IsShowinIEP03] [bit] NOT NULL,
	[IsSewingline] [bit] NOT NULL,
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ArtworkType ID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ArtworkType_FTY', @level2type=N'COLUMN',@level2name=N'ArtworkTypeID'
GO
