                    ...
                    detailTableName == WHTableName.LocalOrderLocationTrans_Detail)
                {
                    ...
                    switch (detailTableName)
                    {
                        ...
                        case WHTableName.LocalOrderReceiving_Detail:
                            ...
                            [Weight] = b.[Weight],
                            [StockType] = 'B',
                            [Barcode] = IIF(wt.To_NewBarcodeSeq <> '' or wt.To_NewBarcodeSeq is not null ,Concat (wt.To_NewBarcode, '-', wt.To_NewBarcodeSeq),wt.To_NewBarcode ),
                            [Ukey] = b.Ukey,
                            [IsInspection] = 0,
                            [ETA] = NULL,
                        ...
                        case WHTableName.LocalOrderIssue_Detail:
                            ...
                            [Roll] = b.Roll,
                            [Dyelot] =b.Dyelot,
                            [Barcode] = IIF(wt.To_OldBarcodeSeq <> '' or wt.To_OldBarcodeSeq is not null ,Concat (wt.From_OldBarcode, '-', wt.From_OldBarcodeSeq),wt.From_OldBarcode ),
                            [NewBarcode] = IIF(wt.To_NewBarcodeSeq <> '' or wt.To_NewBarcodeSeq is not null,Concat (wt.To_NewBarcode, '-', wt.To_NewBarcodeSeq),wt.To_NewBarcode ),
                        ...
                        case WHTableName.LocalOrderAdjust_Detail:
                            ...
                            [Barcode] = IIF((loi.InQty - loi.OutQty + loi.AdjustQty) > 0,
                                        IIF(wt.To_OldBarcodeSeq <> ''  or wt.To_OldBarcodeSeq is not null, wt.To_OldBarcode + '-' + wt.To_OldBarcodeSeq, wt.To_OldBarcode),
                                        IIF(wt.To_NewBarcodeSeq <> ''  or wt.To_NewBarcodeSeq is not null, wt.To_NewBarcode + '-' + wt.To_NewBarcodeSeq, wt.To_NewBarcode)
                                           ),
                            [Ukey] = b.Ukey,
                            [Status] = 'New',
                            [CmdTime] = GETDATE()
                        ...
                        case WHTableName.LocalOrderLocationTrans_Detail:
                            ...
                            [Barcode] = IIF(loi.BarcodeSeq <> '' or loi.BarcodeSeq is not null, Concat (loi.Barcode, '-', loi.BarcodeSeq),loi.Barcode),
                            [Qty] = b.Qty,
                            [Description] = lom.[Desc],
                            [StockType] = b.StockType,
                            [Ukey] = b.Ukey,
