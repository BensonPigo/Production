...
namespace Sci.Production.Centralized
{
    ...
    /// Basic_B14_Machine
    /// </summary>
    public partial class Basic_B14_Machine : Win.Subs.Base
    {
        ...
        public Basic_B14_Machine(DataRow data)
        {
...
",
            ...
            DualResult selectResult1 = DBProxy.Current.Select(this.ConnectionName, selectCommand, out selectDataTable);
