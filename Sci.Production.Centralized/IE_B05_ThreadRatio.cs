...
namespace Sci.Production.Centralized
{
    ...
    /// IE_B05_ThreadRatio
    /// </summary>
    public partial class IE_B05_ThreadRatio : Win.Subs.Base
    {
        private string id;
        ...
        public IE_B05_ThreadRatio(string id)
        {
        ...
        protected override void OnFormLoaded()
        {
            ...
            DataTable gridData;
            DualResult result = DBProxy.Current.Select(this.ConnectionName, sqlCmd, out gridData);
            if (!result)
            {
