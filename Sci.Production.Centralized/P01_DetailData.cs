    ...
    public partial class P01_DetailData : Win.Subs.Base
    {
        ...
        protected override void OnFormLoaded()
        {
            ...
            this.Helper.Controls.Grid.Generator(this.grid1)
                ...
                .Text("CDCodeNew", header: "New CD Code", iseditingreadonly: true)
                .Text("ProductType", header: "ProductType", iseditingreadonly: true)
                .Text("FabricType", header: "FabricType", iseditingreadonly: true)
                .Text("Lining", header: "Lining", iseditingreadonly: true)
                .Text("Gender", header: "Gender", iseditingreadonly: true)
                .Text("Construction", header: "Construction", iseditingreadonly: true)
