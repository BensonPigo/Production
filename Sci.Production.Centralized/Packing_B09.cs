...
namespace Sci.Production.Centralized
{
    ...
    /// Packing_B09
    /// </summary>
    public partial class Packing_B09 : Win.Tems.Input1
    {
        /// <summary>
        /// B09
        /// </summary>
        /// <param name="menuitem">menuitem</param>
        public Packing_B09(ToolStripMenuItem menuitem)
            : base(menuitem)
        {
        ...
        protected override bool ClickSaveBefore()
        {
            ...
            {
                this.CurrentMaintain["Type"] = "PA";
                if (cbResult = DBProxy.Current.Select("ProductionTPE", "select max(id) max_id from PackingReason WITH (NOLOCK) where type='PA'", out whseReasonDt))
                {
