...
select Date
    ...
    , TransFtyZone
    , BalanceExcludeCancelledStillNeedProd = iif(IsCancelNeedProduction  = 'Y', 0, ABS(OrderCPU - sum(SewingOutputCPU)))
...
";
        ...
        protected override bool OnToExcel(Win.ReportDefinition report)
        {
            ...
            worksheet.Columns[19].ColumnWidth = 25;
            worksheet.Columns[20].ColumnWidth = 12; // ISP20220752 新增Article
            worksheet.Columns[21].ColumnWidth = 11.13;
            worksheet.Columns[22].ColumnWidth = 25.25;
            worksheet.Columns[23].ColumnWidth = 20;
            worksheet.Columns[24].ColumnWidth = 7.63;
            worksheet.Columns[25].ColumnWidth = 13.38;
            worksheet.Columns[26].ColumnWidth = 11.88;
            worksheet.Columns[27].ColumnWidth = 15.25;
            worksheet.Columns[28].ColumnWidth = 15.25;
            worksheet.Columns[29].ColumnWidth = 15.25;
            worksheet.Columns[30].ColumnWidth = 25.75;
            worksheet.Columns[31].ColumnWidth = 16.38;
            worksheet.Columns[32].ColumnWidth = 17.5;
            worksheet.Columns[33].ColumnWidth = 17.5;
            worksheet.Columns[34].ColumnWidth = 17.5;
            worksheet.Columns[35].ColumnWidth = 18.13;
            worksheet.Columns[36].ColumnWidth = 8;
            worksheet.Columns[37].ColumnWidth = 22;
            worksheet.Columns[38].ColumnWidth = 16.38;
            worksheet.Columns[39].ColumnWidth = 6.5;
            worksheet.Columns[40].ColumnWidth = 6.5;
            worksheet.Columns[41].ColumnWidth = 19.88;
            worksheet.Columns[42].ColumnWidth = 16.38;
            worksheet.Columns[43].ColumnWidth = 16.38;
            worksheet.Columns[44].ColumnWidth = 16.38;
            worksheet.Columns[45].ColumnWidth = 16.38;
