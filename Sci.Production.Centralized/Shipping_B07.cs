...
namespace Sci.Production.Centralized
{
    ...
    public partial class Shipping_B07 : Win.Tems.Input1
    {
        ...
        private void TxtPort_Leave(object sender, EventArgs e)
        {
            ...
            this.chkIsSeaPort.Checked = MyUtility.Convert.GetBool(MyUtility.GetValue.Lookup($"select SeaPort from Port where id='{this.CurrentMaintain["PoPulloutPortIDrtID"]}'"));
        }
        ...
        private void MergeDatabase(List<PortByBrandShipmode> portByBrandShipmodeList)
        {
            ...
            {
                string tmp = $"SELECT [PulloutPortID]='{portByBrandShipmode.PulloutPortID.ToUpper()}',[BrandID]='{portByBrandShipmode.BrandID.ToUpper()}',Junk={(portByBrandShipmode.Junk ? "1" : "0")}";
...
USING #source s
on t.PulloutPortID = s.PulloutPortID AND t.BrandID = s.BrandID 
...
when not matched by target then
	...
	VALUES(s.PulloutPortID,s.BrandID,s.Junk,'{Sci.Env.User.UserID}',GETDATE())
;
