...
namespace Sci.Production.Centralized
{
    ...
    /// WH_B04
    /// </summary>
    public partial class WH_B04 : Win.Tems.Input1
    {
        /// <summary>
        /// WH_B04
        /// </summary>
        /// <param name="menuitem">menuitem</param>
        public WH_B04(ToolStripMenuItem menuitem)
            : base(menuitem)
        {
        ...
        protected override bool ClickSaveBefore()
        {
            ...
            if (string.IsNullOrWhiteSpace(this.CurrentMaintain["id"].ToString()))
            {
                ...
                if (cbResult = DBProxy.Current.Select("ProductionTPE", "select max(id) max_id from whsereason WITH (NOLOCK) where type='RA'", out whseReasonDt))
                {
