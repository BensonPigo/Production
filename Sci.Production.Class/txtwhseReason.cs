...
namespace Sci.Production.Class
{
    public partial class txtwhseReason : UserControl
    {
        ...
        {
            this.displayBox1.Text = myUtility.Lookup("Description", this.textBox1.Text.ToString(), "WhseReason", "ID");
        }

        private void textBox1_PopUp(object sender, Win.UI.TextBoxPopUpEventArgs e)
        {
            Sci.Win.Tools.SelectItem item = new Sci.Win.Tools.SelectItem("WhseReason.Id, Description", "10,100", this.textBox1.Text);
