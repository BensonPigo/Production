            ...
            try
            {
                ...
                using (sqlConn)
                {
                    ...
                    foreach (var workOrder in excelWk)
                    {
                        ...
                        var layer = workOrder.ExcelLayer > compareOkData.FirstOrDefault().CuttingLayer ? compareOkData.FirstOrDefault().CuttingLayer : workOrder.ExcelLayer;
                        workOrder.Layer = layer;
                        workOrder.CuttingLayer = compareOkData.FirstOrDefault().CuttingLayer;
