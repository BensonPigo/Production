...
";
        ...
        {
            using (var frm = new P09_ImportFromWorkOrderForPlanning(this.CurrentMaintain["ID"].ToString(), (DataTable)this.detailgridbs.DataSource, this.dtWorkOrderForOutput_PatternPanel, this.dtWorkOrderForOutput_SizeRatio))
            {
