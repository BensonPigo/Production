...
{
    /// <inheritdoc/>
    public partial class P06_MachineSummary : Sci.Win.Subs.Base
    {
        private DataTable[] dataTables;

        /// <inheritdoc/>
        public P06_MachineSummary(string lmbID = "")
        {
        ...
        private void LoadData(string lmbID)
        {
            string sqlcmd = $@"
			DECLARE @ALMID bigint = {lmbID}
