    ...
    public partial class P10_P11_Import : Win.Forms.Base
    {
        ...
        protected override void OnFormLoaded()
        {
            ...
            this.Helper.Controls.Grid.Generator(this.gridImport)
                ...
                .Numeric("inqty", header: "In Qty", decimal_places: 2,iseditingreadonly: true, width: Ict.Win.Widths.AnsiChars(6))
                .Numeric("stockunit", header: "Stock Unit", iseditingreadonly: true, width: Ict.Win.Widths.AnsiChars(6))
                .Numeric("outqty", header: "Out Qty", decimal_places: 2, iseditingreadonly: true, width: Ict.Win.Widths.AnsiChars(6))
                .Numeric("adjustqty", header: "Adqty", decimal_places: 2, iseditingreadonly: true, width: Ict.Win.Widths.AnsiChars(6))
                .Numeric("balance", header: "Balance", decimal_places: 2, iseditingreadonly: true, width: Ict.Win.Widths.AnsiChars(6))
                .Numeric("linvqty", header: "Inventory Qty", decimal_places: 2, iseditingreadonly: true, width: Ict.Win.Widths.AnsiChars(6))
                .Numeric("LObQty", header: "Scrap Qty", decimal_places: 2, iseditingreadonly: true, width: Ict.Win.Widths.AnsiChars(6))
