...
namespace Sci.Production.PPIC
{
    ...
    public partial class P11 : Win.Tems.Input6
    {
            ...
            : base(menuitem)
        {
            ...
            this.DefaultFilter = "MDivisionID = '" + Sci.Env.User.Keyword + "' and FabricType = 'A'";
...
where a.RequestQty > a.StockQty",
        ...
        protected override void ClickReceive()
        {
            ...
            DualResult result;
            string updateCmd = string.Format("update Lack set Status = 'Received', EditName = '{0}', EditDate = GetDate() where ID = '{1}'", Sci.Env.User.UserID, MyUtility.Convert.GetString(this.CurrentMaintain["ID"]));
            result = DBProxy.Current.Execute(null, updateCmd);
            if (!result)
            {
        ...
        #region -- SelePoItem --
        private static string selePoItemSqlCmd = @"select  p.id,
        ...
        public static string SelePoItemSqlCmd
        {
            get
            {
                return selePoItemSqlCmd;
            }

            set
            {
                selePoItemSqlCmd = value;
            }
        }
        ...
        /// <param name="defaultseq">string defaultseq</param>
        ...
        public static Sci.Win.Tools.SelectItem2 SelePoItem1(string poid, string defaultseq, string filters = null)
        {
            ...
            Sci.Win.Tools.SelectItem2 selepoitem = new Win.Tools.SelectItem2(
                                                                        dt,
