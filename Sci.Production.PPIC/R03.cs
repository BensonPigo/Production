...
with tmpOrders as (
    ...
    outer apply(
	    ...
	    inner join Marker m on m.UKey = ml.MarkerUkey
	    inner join WorkOrder wo on wo.MarkerNo = m.MarkerNo and wo.MarkerVersion = m.Version
	    where wo.OrderID = o.ID
    )ml
...
";
        ...
        protected override bool OnToExcel(Win.ReportDefinition report)
        {
            ...
            foreach (DataRow dr in this.printData.Rows)
            {
                ...
                objArray[intRowsStart, 53] = dr["MatchFabric"];
