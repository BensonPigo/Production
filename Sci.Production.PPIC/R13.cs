...
select	o.MDivisionID,
		...
		[AT] = isnull(SubProcess.AT,0),
		[BONDING] = isnull(SubProcess.BO,0),
		[EMBRO] = isnull(SubProcess.Emb,0),
		[HT] = isnull(SubProcess.HT,0),
		[PAD-PRT] = isnull(SubProcess.[PAD-PRT],0),
		[PRINTING] = isnull(SubProcess.PRT,0),
		[SubCon] = ls.abb,
