...
namespace Sci.Production.Prg.Entity.NikeMercury
{
    ...
    /// </summary>
    public class ResponseShipmentShippingDetailsUpdateLSP
    {
        /// <summary>
        /// Envelope
        /// </summary>
        ...
        {
            /// <summary>
            /// ShipmentShippingDetailsUpdateLSPResponse
            /// </summary>
            [XmlElement(ElementName = "ShipmentShippingDetailsUpdateLSPResponse", Namespace = "http://tempuri.org/")]
            public ShipmentShippingDetailsUpdateLSPResponse ShipmentShippingDetailsUpdateLSPResponse { get; set; }
        }

        /// <summary>
        /// ShipmentShippingDetailsUpdateLSPResponse
        /// </summary>
        [XmlRoot(ElementName = "ShipmentShippingDetailsUpdateLSPResponse", Namespace = "http://tempuri.org/")]
        public class ShipmentShippingDetailsUpdateLSPResponse
        {
            /// <summary>
            /// ShipmentShippingDetailsUpdateLSPResult
            /// </summary>
            [XmlElement(ElementName = "ShipmentShippingDetailsUpdateLSPResult", Namespace = "http://tempuri.org/")]
            public ShipmentShippingDetailsUpdateLSPResult ShipmentShippingDetailsUpdateLSPResult { get; set; }
        }

        /// <summary>
        /// ShipmentShippingDetailsUpdateLSPResult
        /// </summary>
        public class ShipmentShippingDetailsUpdateLSPResult
        {
            /// <summary>
            /// OutputMessage
            /// </summary>
