...
from #AllOrders x0
inner join Bundle_Detail bunD WITH (NOLOCK) on bunD.Sizecode = x0.Sizecode
inner join Bundle bun WITH (NOLOCK) on bunD.Id = bun.ID and bun.Orderid = x0.Orderid and bun.FabricPanelCode = x0.FabricPanelCode
