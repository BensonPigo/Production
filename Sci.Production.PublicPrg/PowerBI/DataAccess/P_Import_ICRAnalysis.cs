...
namespace Sci.Production.Prg.PowerBI.DataAccess
{
    ...
    public class P_Import_ICRAnalysis
    {
        ...
        /// <inheritdoc/>
        public Base_ViewModel P_ICRAnalysis(DateTime? sDate, DateTime? eDate)
        {
            ...
            try
            {
                Base_ViewModel resultReport = this.GetICRAnalysis_Data((DateTime)sDate, (DateTime)eDate);
        ...
        private Base_ViewModel GetICRAnalysis_Data(DateTime sdate, DateTime edate)
        {
            string sqlcmd = $@"
