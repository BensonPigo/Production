...
namespace Sci.Production.PublicPrg
{
    ...
    public static partial class Prgs
    {
        ...
        public static List<FGWT> GetDefaultFGWT(bool isTop, bool isBottom, bool isTop_Bottom, string mtlTypeID, string washType, string fibresType, bool isAll = true)
        {
            ...
            // 這種情況只需要寫入第88項
            if (mtlTypeID != "WOVEN" && washType == "Hand" && !isAll)
            {
                defaultFGWTList.AddRange(new List<FGWT>()
                {
                    new FGWT() { Location = string.Empty, TestDetail = "pass/fail", Type = "appearance after laundering: Garment - physical changes", Scale = string.Empty },
                });
            ...
            // Criteria欄位視作百分比，knits <= 5% woven <= 2 %
            double criteria_Min = 0;
            double criteria_Max = 0;

            double criteria_Min_Item85 = 0;
            ...
            switch (mtlTypeID)
            {
                case "KNIT":
                    ...
                    {
                        case "Line":
                            if (fibresType == "Natural")
                            {
                                criteria_Min = -5;
                                criteria_Max = 2.5;
                            }

                            if (fibresType == "Synthetic")
                            {
                                criteria_Min = -3;
                                criteria_Max = 2.5;
                            }
                    ...
                    if (isTop_Bottom)
                    {
                        criteria_Min_Item85 = 0;
                        criteria_Max_Item85 = 3.5;
                    }
                    else if (isBottom)
                    {
                        criteria_Min_Item85 = 0;
            ...
            List<FGWT> top = new List<FGWT>()
            {
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment a) length of necktape", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment b) length armhole to bottom hem", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment c) length of front", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment d) length of centre back", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment e) length of underarm", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment f) width across back", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment g) width below centre back neck (average)", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment h) width of sleeve", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: jacket-like garment i) width of sleeve botttom/cuff bottom", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment a) length of necktape", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment b) length armhole to bottom hem", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment c) length of front", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment d) length of centre back", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment e) length of underarm", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment f) width across back", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment g) width below centre back neck(average)", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment h) width of sleeve", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of jacket-like garment i) width of sleeve botttom/ cuff bottom", Criteria = criteria_Min, Criteria2 = criteria_Max },
            };

            List<FGWT> bottom = new List<FGWT>()
            {
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: trouser-like garment a) length of front leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: trouser-like garment b) length of back leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: trouser-like garment c) length of inside leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: trouser-like garment d) width at waist", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: trouser-like garment e) width at bottom of leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: trouser-like garment f) width of leg halfway", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: trouser-like garment g) width of top of leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of trouser-like garment a) length of front leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of trouser-like garment b) length of back leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of trouser-like garment c) length of inside leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of trouser-like garment d) width at waist", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of trouser-like garment e) width at bottom of leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of trouser-like garment f) width of leg halfway", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of trouser-like garment g) width of top of leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: skirt a) length from waist to bottom hem", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: skirt b) width at waistband", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: skirt c) width below top/bottom edge of waistband (average)", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of skirt a) length from waist to bottom hem", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of skirt b) width at waistband", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of skirt c) width below top/bottom edge of waistband (average)", Criteria = criteria_Min, Criteria2 = criteria_Max },
            };

            List<FGWT> top_bottom = new List<FGWT>()
            {
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear a) length of neckktape", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear b) length armhole to bottom hem", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear c) length of centre front", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear d) length of centre back", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear e) length of underarm", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear f) width across back", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear g) width below centre back neck (average)", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear h) width of sleeve", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear i) width of sleeve botttom/cuff bottom", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear j) length of front leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear k) length of back leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear l) length of inside leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear m) width at waist", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear n) width at bottom of leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear o) width of leg halfway", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: full body wear p) width of top of leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear a) length of neckktape", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear b) length armhole to bottom hem", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear c) length of centre front", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear d) length of centre back", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear e) length of underarm", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear f) width across back", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear g) width below centre back neck (average)", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear h) width of sleeve", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear i) width of sleeve botttom/cuff bottom", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear j) length of front leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear k) length of back leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear l) length of inside leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear m) width at waist", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear n) width at bottom of leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear o) width of leg halfway", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = "Top+Bottom", TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: lining of full body wear p) width of top of leg", Criteria = criteria_Min, Criteria2 = criteria_Max },
            };

            // All項目最後會寫入空白
            List<FGWT> all = new List<FGWT>()
            {
                new FGWT() { Location = string.Empty, TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: flat made-up textile articles a) overall length", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = string.Empty, TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "dimensional change: flat made-up textile articles b) overall width", Criteria = criteria_Min, Criteria2 = criteria_Max },
                new FGWT() { Location = string.Empty, TestDetail = $"{criteria_Min}~{criteria_Max}%", Type = "spirality: Garment - in percentage (average)", Criteria = criteria_Min_Item85, Criteria2 = criteria_Max_Item85 },
