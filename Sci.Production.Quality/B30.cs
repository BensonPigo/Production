...
{
    /// <inheritdoc/>
    public partial class B30 : Sci.Win.Tems.Input1
    {
        /// <summary>
        /// B31
        /// </summary>
        /// <param name="menuitem">menuitem</param>
        public B30(ToolStripMenuItem menuitem)
            : base(menuitem)
        {
        ...
        protected override bool ClickSaveBefore()
        {
            ...
            {
                string chkpk = $@"select FactoryID from LostFinalInspNotification with(nolock) where FactoryID = '{this.CurrentMaintain["FactoryID"]}'";
