...
{
    /// <inheritdoc/>
    public partial class P01_BatchUpdateShadeBand : Win.Tems.QueryForm
    {
        private string poid;
        ...
        /// <inheritdoc/>
        public P01_BatchUpdateShadeBand(string poid)
        {
        ...
        private void GridSetup()
        {
            ...
            this.Helper.Controls.Grid.Generator(this.grid)
                ...
                .Text("ShadebondEncodeDisplay", header: "Encode", width: Widths.AnsiChars(8), iseditingreadonly: true)
                ;
...
SELECT
    ...
    ,fs.Remark
    ,f.ShadebondEncode
    ,ShadebondEncodeDisplay = IIF(f.ShadebondEncode = 1, 'Encode', 'Amend')
    ,FIRID = f.ID
...
";
        ...
        private void Grid_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                if (!MyUtility.Convert.GetBool(dr["ShadebondEncode"]))
                {
                    if (MyUtility.Convert.GetBool(dr["Selected"]))
                    {
                        dr["Inspdate"] = DateTime.Now;
