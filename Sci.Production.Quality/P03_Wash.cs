...
namespace Sci.Production.Quality
{
    public partial class P03_Wash : Sci.Win.Subs.Input4
    {
        ...
        private void ToExcel_Click(object sender, EventArgs e)
        {
            ...
            "select C.SeasonID from FIR_Laboratory_Wash a left join FIR_Laboratory b on a.ID=b.ID LEFT JOIN ORDERS C ON B.POID=C.ID where a.ID='{0}'", maindr["ID"]), out dtSeason);
