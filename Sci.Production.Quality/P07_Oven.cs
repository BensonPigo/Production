...
namespace Sci.Production.Quality
{
    public partial class P07_Oven : Win.Subs.Input2A
    {
        ...
        protected override void OnFormLoaded()
        {
            ...
            if (this.EDIT)
            {
                if (Convert.ToBoolean(this.maindr["OvenEncode"]))
                {
        ...
        private void OnRequery()
        {
             ...
             if (MyUtility.Check.Seek(this.sql, out this.DR))
            {
             ...
             this.comboResult.SelectedValue2 = this.maindr["Oven"].ToString().Trim();
        }
        ...
        private void btnEncode_Click(object sender, EventArgs e)
        {
            if (this.btnEncode.Text == "Encode")
            {
                ...
                if (Convert.ToBoolean(this.maindr["WashEncode"]) || Convert.ToBoolean(this.maindr["NonWash"]))
                {
...
";
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (MyUtility.Check.Empty(this.dateInspectDate.Value))
                {
                    this.CurrentData["OvenDate"] = DateTime.Now;
                }
