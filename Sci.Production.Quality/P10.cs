...
Delete SampleGarmentTest_Detail_FGPT where id = '{this.CurrentMaintain["ID", DataRowVersion.Original]}' and NO = '{dr["NO", DataRowVersion.Original]}'
Delete SampleGarment_Detail_Spirality where id = '{this.CurrentMaintain["ID", DataRowVersion.Original]}' and NO = '{dr["NO", DataRowVersion.Original]}'
";
...
";
                    ...
                    #region 建立 SampleGarment_Detail_Spirality
...
";
                        ...
                        {
                            sqlcmd += $@"INSERT INTO[dbo].[SampleGarment_Detail_Spirality]([ID],[No],[Location])VALUES('{dr["ID"]}','{dr["NO"]}','T')";
                        }

                        if (locationdt.Select("Location = 'B'").Any())
                        {
                            sqlcmd += $@"INSERT INTO[dbo].[SampleGarment_Detail_Spirality]([ID],[No],[Location])VALUES('{dr["ID"]}','{dr["NO"]}','B')";
                        }
