...
masterID);
        ...
        {
            P11_Detail callNewDetailForm = new P11_Detail(true, this.CurrentMaintain["ID"].ToString(), string.Empty, null, "New");
        ...
        {
            P11_Detail callNewDetailForm = new P11_Detail(true, this.CurrentMaintain["ID"].ToString(), this.CurrentDetailData["ReportNo"].ToString(), null, "Edit");
            callNewDetailForm.ShowDialog(this);
            callNewDetailForm.Dispose();
            this.RenewData();
            this.OnDetailEntered();
        ...
        protected override bool OnGridSetup()
        {
            ...
            this.detailgrid.CellDoubleClick += (s, e) =>
            {
                ...
                P11_Detail callNewDetailForm = new P11_Detail(false, this.CurrentMaintain["ID"].ToString(), this.CurrentDetailData["ReportNo"].ToString(), null, "Query");
                callNewDetailForm.ShowDialog(this);
                callNewDetailForm.Dispose();
            };
