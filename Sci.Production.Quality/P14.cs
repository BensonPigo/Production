...
masterID);
        ...
        {
            P14_Detail callNewDetailForm = new P14_Detail(true, this.CurrentMaintain["ID"].ToString(), string.Empty, null, "New");
        ...
        {
            P14_Detail callNewDetailForm = new P14_Detail(true, this.CurrentMaintain["ID"].ToString(), this.CurrentDetailData["ReportNo"].ToString(), null, "Edit");
            callNewDetailForm.ShowDialog(this);
            callNewDetailForm.Dispose();
            this.RenewData();
            this.OnDetailEntered();
        ...
        protected override bool OnGridSetup()
        {
            ...
            this.detailgrid.CellDoubleClick += (s, e) =>
            {
                ...
                P14_Detail callNewDetailForm = new P14_Detail(false, this.CurrentMaintain["ID"].ToString(), this.CurrentDetailData["ReportNo"].ToString(), null, "Query");
                callNewDetailForm.ShowDialog(this);
                callNewDetailForm.Dispose();
            };
        ...
        protected override bool ClickSaveBefore()
        {
            ...
            {
                string tmpId = MyUtility.GetValue.GetID(Env.User.Keyword + "OV", "MockupOven", DateTime.Now);
