...
namespace Sci.Production.Quality
{
    public partial class R02 : Sci.Win.Tems.PrintForm
    {
            ...
            : base(menuitem)
        {
            ...
            this.textBox_Cate.DataSource = ORS;
            this.textBox_Cate.ValueMember = "Category";
            this.textBox_Cate.DisplayMember = "Category";
            this.textBox_Cate.SelectedIndex = 1;
        ...
        {
            bool date_Arrive_Empty = !this.date_Arrive.HasValue, date_SCI_Empty = !this.date_SCI.HasValue, date_Sewing_Empty = !this.date_Sewing.HasValue, date_Est_Empty = !this.date_Est.HasValue,
               textBox_SP_Empty = this.textBox_SP.Text.Empty(), textBox_SP2_Empty = this.textBox_SP2.Text.Empty(), txtSEA_Empty = this.txtSeason1.Text.Empty()
          , txtBrand_Empty = this.txtBrand1.Text.Empty(), txtRef_Empty = this.textBox_Ref.Text.Empty(), Cate_comboBox_Empty = this.textBox_Cate.Text.Empty(), Supp_Empty = this.txtsupplier1.Text.Empty(), Over_comboBox_Empty = this.comboBox_Over.Text.Empty();
            ...
            } if (!this.textBox_Cate.SelectedItem.ToString().Empty())
            {
