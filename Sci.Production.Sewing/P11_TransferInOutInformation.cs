...
select
	...
	, buybackQty_in.buybackQty
	, CancelQty_in.CancelQty
	, sotd.TransferQty
	, TransferInQty = sotd.TransferQty
	, TransferOutQty = 0
...
select
	...
	, sotd.ToOrderID
	, sotd.FromOrderID
	, buybackQty_Out.buybackQty
	, CancelQty_Out.CancelQty
	, sotd.TransferQty
	, TransferInQty = 0
	, TransferOutQty = sotd.TransferQty
	, sotd.FromComboType
	, sotd.Article
	, sotd.SizeCode
from SewingOutputTransfer sot
...
select d.*, g.QAQty, SewingQty = IIF(SewingQty.SewingQty < 0, 0, SewingQty.SewingQty)
from(
