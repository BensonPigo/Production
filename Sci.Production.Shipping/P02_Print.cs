...
group by UnitID", MyUtility.Convert.GetString(this.masterData["ID"]));
        ...
        protected override bool OnToExcel(Win.ReportDefinition report)
        {
            if (this.reportType == "1")
            {
                ...
                worksheet.Cells[5, 2] = MyUtility.Check.Empty(this.masterData["ShipDate"]) ? string.Empty : Convert.ToDateTime(this.masterData["ShipDate"]).ToString("yyyy/MM/dd");
                ...
                worksheet.Cells[6, 2] = MyUtility.Check.Empty(this.masterData["ETD"]) ? string.Empty : Convert.ToDateTime(this.masterData["ETD"]).ToString("yyyy/MM/dd");
                ...
                worksheet.Cells[7, 2] = MyUtility.Check.Empty(this.masterData["ETA"]) ? string.Empty : Convert.ToDateTime(this.masterData["ETA"]).ToString("yyyy/MM/dd");
            ...
            else if (this.reportType == "2")
            {
                ...
                worksheet.Cells[8, 4] = MyUtility.Check.Empty(this.masterData["ETD"]) ? string.Empty : Convert.ToDateTime(this.masterData["ETD"]).ToString("yyyy/MM/dd");
            ...
            else if (this.reportType == "3")
            {
                ...
                worksheet.Cells[9, 1] = this.courierAWB;
                worksheet.Cells[8, 9] = MyUtility.Check.Empty(this.masterData["ETD"]) ? string.Empty : Convert.ToDateTime(this.masterData["ETD"]).ToString("yyyy/MM/dd");
