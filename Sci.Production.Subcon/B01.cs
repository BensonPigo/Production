...
";
        ...
        protected override bool ClickSaveBefore()
        {
            ...
            string chk = $@"select 1 from LocalItem where RefNo='{this.CurrentMaintain["Refno"]}' AND CtnHeight = '{MyUtility.Convert.GetDecimal(this.CurrentMaintain["CtnHeight"])}' AND CtnUnit = '{this.CurrentMaintain["CtnUnit"]}' ";
