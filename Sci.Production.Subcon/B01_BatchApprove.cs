...
";
        ...
        private void BtnToExcel_Click(object sender, EventArgs e)
        {
            ...
            Microsoft.Office.Interop.Excel._Application excel = MyUtility.Excel.ConnectExcel(Env.Cfg.XltPathDir + "\\Subcon_B01.xltx"); // 預先開啟excel app
            ...
            #region Save Excel
            string strExcelName = Class.MicrosoftFile.GetName("Subcon_B01");
