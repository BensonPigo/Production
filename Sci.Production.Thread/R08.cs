...
namespace Sci.Production.Thread
{
    ...
    public partial class R08 : Win.Tems.PrintForm
    {
        ...
        protected override bool OnToExcel(Win.ReportDefinition report)
        {
            ...
            if (this.radioDetail.Checked == true)
            {
                objApp = MyUtility.Excel.ConnectExcel(Env.Cfg.XltPathDir + "\\Thread_R08.xltx"); // 預先開啟excel app
            ...
            {
                objApp = MyUtility.Excel.ConnectExcel(Env.Cfg.XltPathDir + "\\Thread_R08_Summary.xltx");
            ...
            string strExcelName = Class.MicrosoftFile.GetName(this.radioDetail.Checked == true ? "Thread_R08" : "Thread_R08_Summary");
