...
namespace Sci.Production.Warehouse
{
    public partial class P78 : Sci.Win.Tems.Input6
    {
        ...
        protected override bool ClickSaveBefore()
        {
            ...
            {
                string tmpId = Sci.MyUtility.GetValue.GetID(Sci.Env.User.Keyword + "XG", "Issue", (DateTime)CurrentMaintain["Issuedate"]);
        ...
        protected override void OnDetailGridSetup()
        {
            ...
            .Text("stocktype", header: "Stock" + Environment.NewLine + "Type", iseditingreadonly: true, width: Widths.AnsiChars(4))
