...
(Select isnull(SpecValue, '') from PO_Supp_Detail_Spec d WITH (NOLOCK) Where d.id = a.poid and d.seq1 = a.seq1 and d.seq2 = a.seq2 and d.SpecColumnID = 'Color') as Colorid,
