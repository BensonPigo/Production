...
{
    public partial class P16_AccumulatedQty : Sci.Win.Subs.Base
    {
...
GROUP BY A.PoId,b.Seq1,b.Seq2,b.RequestQty", this.dr["requestid"], this.dr["id"]));
