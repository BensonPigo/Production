...
namespace Sci.Production.Warehouse
{
    public partial class P22 : Sci.Win.Tems.Input6
    {
        ...
        protected override bool ClickSaveBefore()
        {
            ...
            {
                string tmpId = Sci.MyUtility.GetValue.GetID(Sci.Env.User.Factory + "ST", "SubTransfer", (DateTime)CurrentMaintain["Issuedate"]);
...
where f.InQty > 0 and toroll !='' and toroll is not null and d.Id = '{0}'", CurrentMaintain["id"]);
            ...
            var data_MD_0F = (from b in ((DataTable)detailgridbs.DataSource).AsEnumerable()
                              group b by new
                              {
        ...
        protected override bool ClickPrint()
        {
            ...
            @"select a.FromPOID
                    ...
                    ,IIF((b.ID = lag(b.ID,1,'')over (order by b.ID,b.seq1,b.seq2) 
                     ...
                     ,a.FromDyelot
		             ,a.Qty
		             ,[From_Location]=dbo.Getlocation(a.FromFtyInventoryUkey)
			         ,a.ToLocation 
