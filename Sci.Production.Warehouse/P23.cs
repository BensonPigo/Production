...
namespace Sci.Production.Warehouse
{
    public partial class P23 : Sci.Win.Tems.Input6
    {
        ...
        protected override bool ClickSaveBefore()
        {
            ...
            {
                string tmpId = Sci.MyUtility.GetValue.GetID(Sci.Env.User.Keyword + "PI", "SubTransfer", (DateTime)this.CurrentMaintain["Issuedate"]);
...
Where a.id = '{0}'", masterID);
        ...
        {
            var frm = new Sci.Production.Warehouse.P23_Import(this.CurrentMaintain, (DataTable)this.detailgridbs.DataSource);
            frm.ShowDialog(this);
            this.RenewData();
        }
        ...
        {
            var frm = new Sci.Production.Warehouse.P23_AccumulatedQty(this.CurrentMaintain);
            frm.P23 = this;
            frm.ShowDialog(this);
        }
