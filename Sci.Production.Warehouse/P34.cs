...
,a.StockType
,stuff((select ',' + mtllocationid from (select mtllocationid from dbo.ftyinventory_detail fd WITH (NOLOCK) where ukey= a.ftyinventoryukey) t for xml path('')), 1, 1, '') location
,a.ukey
,a.ftyinventoryukey
