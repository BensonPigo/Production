...
select  0 as selected 
        ...
        , p1.stockunit
        , f.StockType 
        , f.InQty - f.OutQty + f.AdjustQty - f.ReturnQty balance
        , 0.00 as qty
...
inner join dbo.FtyInventory f WITH (NOLOCK) on f.POID = b.PoId and f.seq1 = b.seq1 and f.seq2 = b.Seq2 and f.stocktype = b.stocktype and f.Roll = b.Roll and f.Dyelot = b.Dyelot
