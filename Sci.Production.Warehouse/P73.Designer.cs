namespace Sci.Production.Warehouse
{
    partial class P73
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Grid2New = 0;
            this.GridAlias = "LocalOrderLocationTrans_Detail";
            this.GridNew = 0;
            this.GridUniqueKey = "poid,seq1,seq2,roll,Dyelot,StockType";
            this.IsSupportConfirm = true;
            this.IsSupportCopy = false;
            this.KeyField1 = "ID";
            this.Name = "P73";
            this.OnLineHelpID = "Sci.Win.Tems.Input6";
            this.Text = "P73. Update Location (Local Order)";
            this.UniqueExpress = "id";
            this.WorkAlias = "LocalOrderLocationTrans";
